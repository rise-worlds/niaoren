...
public final class AndroidHttpClient implements HttpClient {
    ...
    public static AndroidHttpClient newInstance(String userAgent, Context context) {
        ...
        schemeRegistry.register(new Scheme("https", SSLCertificateSocketFactory.getHttpSocketFactory(60000, sessionCache), AbstractC2752bw.f13639b));
    ...
    public static void modifyRequestToAcceptGzipResponse(HttpRequest request) {
        request.addHeader(com.github.kevinsawicki.http.HttpRequest.HEADER_ACCEPT_ENCODING, com.github.kevinsawicki.http.HttpRequest.ENCODING_GZIP);
    }
    ...
    public static InputStream getUngzippedContent(HttpEntity entity) throws IOException {
        ...
        return (responseStream == null || (header = entity.getContentEncoding()) == null || (contentEncoding = header.getValue()) == null) ? responseStream : contentEncoding.contains(com.github.kevinsawicki.http.HttpRequest.ENCODING_GZIP) ? new GZIPInputStream(responseStream) : responseStream;
    }
    ...
    public static AbstractHttpEntity getCompressedEntity(byte[] data, ContentResolver resolver) throws IOException {
        ...
        entity.setContentEncoding(com.github.kevinsawicki.http.HttpRequest.ENCODING_GZIP);
        return entity;
    }
    ...
    public static String toCurl(HttpUriRequest request, boolean logAuthToken) throws IOException {
        ...
        builder.append(ExpandableTextView.f6958c);
        for (Header header : request.getAllHeaders()) {
            if (logAuthToken || (!header.getName().equals("Authorization") && !header.getName().equals(AbstractC3144SM.COOKIE))) {
