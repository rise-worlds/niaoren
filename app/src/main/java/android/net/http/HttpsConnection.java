...
public class HttpsConnection extends Connection {
    ...
    public static void initializeEngine(File sessionDir) {
        ...
        if (sessionDir != null) {
            try {
                Log.d("HttpsConnection", "Caching SSL sessions in " + sessionDir + Consts.f23430h);
            ...
            try {
                ...
                try {
                    ...
                    for (Header h : req.mHttpRequest.getAllHeaders()) {
                        ...
                        if (headerName.startsWith("proxy") || headerName.equals("keep-alive") || headerName.equals(C3883at.f17482f)) {
