...
public class ArrayRow implements LinearSystem.Row {
    ...
    public String toReadableString() {
        ...
        float variableValue;
        int i;
        String str = (this.variable == null ? "" + ResultTypeConstant.f7213z : "" + this.variable) + " = ";
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            if (!(variable == null || (variableValue = this.variables.getVariableValue(i3)) == 0.0f)) {
                ...
                str = variableValue == 1.0f ? str + solverVariable : str + variableValue + ExpandableTextView.f6958c + solverVariable;
                z = true;
            }
        }
        if (z) {
