...
public class ConstraintWidget {
    ...
    public String toString() {
        ...
        if (this.mType != null) {
            str = "type: " + this.mType + ExpandableTextView.f6958c;
        } else {
            str = "";
        }
        sb.append(str);
        if (this.mDebugName != null) {
            str2 = "id: " + this.mDebugName + ExpandableTextView.f6958c;
        } else {
            str2 = "";
        }
        sb.append(str2);
    ...
    /* JADX WARN: Removed duplicated region for block: B:125:0x026a A[RETURN] */
