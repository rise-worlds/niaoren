    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor constraintAnchor) {
        ...
        switch (this.mType) {
            ...
            case NONE:
                return false;
            case LEFT:
                int i = C00851.f5x1d400623[constraintAnchor.getType().ordinal()];
                return i == 3 || i == 7;
            case RIGHT:
                int i2 = C00851.f5x1d400623[constraintAnchor.getType().ordinal()];
                return i2 == 2 || i2 == 7;
            case TOP:
                int i3 = C00851.f5x1d400623[constraintAnchor.getType().ordinal()];
                return i3 == 5 || i3 == 8;
            case BOTTOM:
                int i4 = C00851.f5x1d400623[constraintAnchor.getType().ordinal()];
                return i4 == 4 || i4 == 8;
            case CENTER_X:
