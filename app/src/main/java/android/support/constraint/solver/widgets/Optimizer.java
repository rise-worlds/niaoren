    ...
    public static boolean applyChainOptimized(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead) {
        ...
        while (!z5) {
            if (constraintWidget9.getVisibility() != 8) {
                i4++;
                if (i == 0) {
                    f5 += constraintWidget9.getWidth();
                } else {
                    f5 += constraintWidget9.getHeight();
                }
                if (constraintWidget9 != constraintWidget4) {
                    f5 += constraintWidget9.mListAnchors[i2].getMargin();
                }
                if (constraintWidget9 != constraintWidget5) {
                    f5 += constraintWidget9.mListAnchors[i2 + 1].getMargin();
                }
                f6 = f6 + constraintWidget9.mListAnchors[i2].getMargin() + constraintWidget9.mListAnchors[i2 + 1].getMargin();
            }
        ...
        if (z3 || z2 || z) {
            f = constraintWidget4 != null ? constraintWidget4.mListAnchors[i2].getMargin() : 0.0f;
            if (constraintWidget5 != null) {
                f += constraintWidget5.mListAnchors[i5].getMargin();
            }
        } else {
            f = 0.0f;
        }
        ...
        if (i3 <= 0 || i3 != i4) {
            ...
            if (z3) {
                ...
                while (constraintWidget11 != null) {
                    ...
                    if (constraintWidget12 != null || constraintWidget11 == constraintWidget3) {
                        if (i == 0) {
                            f3 = constraintWidget11.getWidth();
                        } else {
                            f3 = constraintWidget11.getHeight();
                        }
                        float margin = biasPercent + constraintWidget11.mListAnchors[i2].getMargin();
                        ...
                        biasPercent = f10 + constraintWidget11.mListAnchors[i5].getMargin();
                    }
            ...
            float f11 = f9 / (i4 + 1);
            if (z) {
                f11 = i4 > 1 ? f9 / (i4 - 1) : f9 / 2.0f;
            }
            float f12 = constraintWidget13.getVisibility() != 8 ? f7 + f11 : f7;
            if (z && i4 > 1) {
                f12 = constraintWidget4.mListAnchors[i2].getMargin() + f7;
            }
            ...
            while (constraintWidget13 != null) {
                ...
                if (constraintWidget14 != null || constraintWidget13 == constraintWidget3) {
                    if (i == 0) {
                        f2 = constraintWidget13.getWidth();
                    } else {
                        f2 = constraintWidget13.getHeight();
                    }
                    ...
                    f12 += f2 + constraintWidget13.mListAnchors[i5].getMargin();
                    if (!(constraintWidget14 == null || constraintWidget14.getVisibility() == 8)) {
                        f12 += f11;
                    }
                }
            ...
            while (constraintWidget15 != null) {
                ...
                if (constraintWidget16 != null || constraintWidget15 == constraintWidget3) {
                    float f14 = f13 / i3;
                    if (f4 > 0.0f) {
                        f14 = constraintWidget15.mWeight[i] == -1.0f ? 0.0f : (constraintWidget15.mWeight[i] * f13) / f4;
                    }
                    if (constraintWidget15.getVisibility() == 8) {
                        f14 = 0.0f;
                    }
                    float margin2 = f7 + constraintWidget15.mListAnchors[i2].getMargin();
                    ...
                    f7 = f15 + constraintWidget15.mListAnchors[i5].getMargin();
                }
