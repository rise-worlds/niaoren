...
public class ArrayLinkedVariables {
    ...
    public final void put(SolverVariable solverVariable, float f) {
        ...
        this.mArrayIndices[i6] = solverVariable.f4id;
    ...
    public final void updateFromRow(ArrayRow arrayRow, ArrayRow arrayRow2, boolean z) {
        ...
        int i2 = 0;
        while (i != -1 && i2 < this.currentSize) {
            if (this.mArrayIndices[i] == arrayRow2.variable.f4id) {
    ...
    public SolverVariable getPivotCandidate(boolean[] zArr, SolverVariable solverVariable) {
        ...
        for (int i2 = 0; i != -1 && i2 < this.currentSize; i2++) {
            if (this.mArrayValues[i] < 0.0f) {
                SolverVariable solverVariable3 = this.mCache.mIndexedVariables[this.mArrayIndices[i]];
                if ((zArr == null || !zArr[solverVariable3.f4id]) && solverVariable3 != solverVariable && (solverVariable3.mType == SolverVariable.Type.SLACK || solverVariable3.mType == SolverVariable.Type.ERROR)) {
    ...
    public void display() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                printStream.print(variable + " = " + getVariableValue(i2) + ExpandableTextView.f6958c);
            }
        }
        System.out.println(" }");
    }
