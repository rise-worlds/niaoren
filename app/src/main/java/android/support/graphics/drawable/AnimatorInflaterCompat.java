...
import android.support.p003v4.graphics.PathParser;
...
public class AnimatorInflaterCompat {
    ...
    private static void parseAnimatorFromTypeArray(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f, XmlPullParser xmlPullParser) {
        ...
        long namedInt2 = TypedArrayUtils.getNamedInt(typedArray, xmlPullParser, ConnectionModel.f10391c, 2, 0);
    ...
    */
    ...
    private static int inferValueTypeOfKeyframe(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        ...
        int i = 0;
        TypedValue peekNamedValue = TypedArrayUtils.peekNamedValue(obtainAttributes, xmlPullParser, SizeSelector.SIZE_KEY, 0);
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        if (z) {
            if (i != 3) {
                switch (i) {
                    case 0:
                        keyframe = Keyframe.ofFloat(namedFloat, TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser, SizeSelector.SIZE_KEY, 0, 0.0f));
                        break;
                    case 1:
                        break;
                    default:
            ...
            keyframe = Keyframe.ofInt(namedFloat, TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, SizeSelector.SIZE_KEY, 0, 0));
        } else if (i == 0) {
