...
import android.support.p006v7.widget.MenuItemHoverListener;
import android.support.p006v7.widget.MenuPopupWindow;
...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C0455R.layout.abc_cascading_menu_item_layout;
    ...
    private final MenuItemHoverListener mMenuItemHoverListener = new MenuItemHoverListener() { // from class: android.support.v7.view.menu.CascadingMenuPopup.3
        @Override // android.support.p006v7.widget.MenuItemHoverListener
    ...
    @Override // android.support.p006v7.view.menu.MenuPopup
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0455R.dimen.abc_config_prefDialogWidth));
    }
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) from.inflate(C0455R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
