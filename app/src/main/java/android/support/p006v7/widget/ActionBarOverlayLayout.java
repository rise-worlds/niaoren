...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    ...
    static final int[] ATTRS = {C0455R.attr.actionBarSize, 16842841};
    ...
    @Override // android.support.p006v7.widget.DecorContentParent
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0455R.C0457id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0455R.C0457id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0455R.C0457id.action_bar));
        }
    }
