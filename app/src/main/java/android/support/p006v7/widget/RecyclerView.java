...
import android.support.annotation.AbstractC0074Px;
...
import android.support.p003v4.util.Preconditions;
import android.support.p003v4.view.AbsSavedState;
import android.support.p003v4.view.NestedScrollingChild2;
import android.support.p003v4.view.NestedScrollingChildHelper;
import android.support.p003v4.view.ScrollingView;
import android.support.p003v4.view.ViewCompat;
import android.support.p003v4.view.ViewConfigurationCompat;
import android.support.p003v4.view.accessibility.AccessibilityEventCompat;
import android.support.p003v4.view.accessibility.AccessibilityNodeInfoCompat;
import android.support.p003v4.widget.EdgeEffectCompat;
import android.support.p006v7.recyclerview.C0461R;
import android.support.p006v7.widget.AdapterHelper;
import android.support.p006v7.widget.ChildHelper;
import android.support.p006v7.widget.GapWorker;
import android.support.p006v7.widget.ViewBoundsCheck;
import android.support.p006v7.widget.ViewInfoStore;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    public static class SimpleOnItemTouchListener implements OnItemTouchListener {
        @Override // android.support.p006v7.widget.RecyclerView.OnItemTouchListener
    ...
    public void onScrolled(@AbstractC0074Px int i, @AbstractC0074Px int i2) {
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() { // from class: android.support.v7.widget.RecyclerView.4
            @Override // android.support.p006v7.widget.ViewInfoStore.ProcessCallback
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0461R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0461R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0461R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0461R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0461R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0461R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0461R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0461R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    String exceptionLabel() {
        return ExpandableTextView.f6958c + super.toString() + ", adapter:" + this.mAdapter + ", layout:" + this.mLayout + ", context:" + getContext();
    }
    ...
    private String getFullClassName(Context context, String str) {
        ...
        } else if (str.contains(Consts.f23430h)) {
            return str;
        } else {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() { // from class: android.support.v7.widget.RecyclerView.5
            @Override // android.support.p006v7.widget.ChildHelper.Callback
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: android.support.v7.widget.RecyclerView.6
            @Override // android.support.p006v7.widget.AdapterHelper.Callback
    ...
    */
    boolean scrollByInternal(int r19, int r20, android.view.MotionEvent r21) {
        ...
        L_0x0076:
            ...
            boolean r0 = android.support.p003v4.view.MotionEventCompat.isFromSource(r10, r0)
        ...
        L_0x00b1:
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.RecyclerView.scrollByInternal(int, int, android.view.MotionEvent):boolean");
    }

    @Override // android.view.View, android.support.p003v4.view.ScrollingView
    ...
    public void smoothScrollBy(@AbstractC0074Px int i, @AbstractC0074Px int i2) {
        smoothScrollBy(i, i2, null);
    }

    public void smoothScrollBy(@AbstractC0074Px int i, @AbstractC0074Px int i2, @Nullable Interpolator interpolator) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutFrozen) {
    ...
    */
    protected void onAttachedToWindow() {
        ...
        L_0x001e:
            ...
            boolean r0 = android.support.p006v7.widget.RecyclerView.ALLOW_THREAD_GAP_WORK
            if (r0 == 0) goto L_0x0069
            java.lang.ThreadLocal<android.support.v7.widget.GapWorker> r0 = android.support.p006v7.widget.GapWorker.sGapWorker
            java.lang.Object r0 = r0.get()
            android.support.v7.widget.GapWorker r0 = (android.support.p006v7.widget.GapWorker) r0
            r4.mGapWorker = r0
            ...
            r0.<init>()
            r4.mGapWorker = r0
            android.view.Display r0 = android.support.p003v4.view.ViewCompat.getDisplay(r4)
        ...
        L_0x0069:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.RecyclerView.onAttachedToWindow():void");
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.RecyclerView.onTouchEvent(android.view.MotionEvent):boolean");
    }
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            ...
            if (!z && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), MemoryConstants.f21646d), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), MemoryConstants.f21646d));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(i, i2);
                }
    ...
    */
    public android.view.View findContainingItemView(@android.support.annotation.NonNull android.view.View r3) {
        ...
        L_0x0018:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.RecyclerView.findContainingItemView(android.view.View):android.view.View");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    android.support.p006v7.widget.RecyclerView.ViewHolder findViewHolderForPosition(int r6, boolean r7) {
        /*
            r5 = this;
        ...
        L_0x003a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.RecyclerView.findViewHolderForPosition(int, boolean):android.support.v7.widget.RecyclerView$ViewHolder");
    }
    ...
    public void offsetChildrenVertical(@AbstractC0074Px int i) {
        int childCount = this.mChildHelper.getChildCount();
    ...
    public void offsetChildrenHorizontal(@AbstractC0074Px int i) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
    ...
    public class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        @Override // android.support.p006v7.widget.RecyclerView.AdapterDataObserver
    ...
    public final class Recycler {
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public android.support.p006v7.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            /*
                Method dump skipped, instructions count: 629
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.RecyclerView.Recycler.tryGetViewHolderForPositionByDeadline(int, boolean, long):android.support.v7.widget.RecyclerView$ViewHolder");
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback = new ViewBoundsCheck.Callback() { // from class: android.support.v7.widget.RecyclerView.LayoutManager.1
            @Override // android.support.p006v7.widget.ViewBoundsCheck.Callback
            public int getChildCount() {
        ...
        void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = MemoryConstants.f21646d;
            this.mHeightMode = MemoryConstants.f21646d;
        }
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0461R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0461R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0461R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0461R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0461R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }

        void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), MemoryConstants.f21646d), View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), MemoryConstants.f21646d));
        }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0461R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0461R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0461R.dimen.fastscroll_margin));
    }

    @Override // android.view.View, android.support.p003v4.view.NestedScrollingChild
    ...
    @Override // android.support.p003v4.view.NestedScrollingChild2
    ...
    public static abstract class SmoothScroller {
        ...
        protected abstract void onSeekTargetStep(@AbstractC0074Px int i, @AbstractC0074Px int i2, @NonNull State state, @NonNull Action action);
        ...
        void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            if (this.mStarted) {
                Log.w(RecyclerView.TAG, "An instance of " + getClass().getSimpleName() + " was started more than once. Each instance of" + getClass().getSimpleName() + ExpandableTextView.f6958c + "is intended to only be used once. You should create a new instance for each use.");
            }
            this.mRecyclerView = recyclerView;
        ...
        public static class Action {
            ...
            public Action(@AbstractC0074Px int i, @AbstractC0074Px int i2) {
                this(i, i2, Integer.MIN_VALUE, null);
            }

            public Action(@AbstractC0074Px int i, @AbstractC0074Px int i2, int i3) {
                this(i, i2, i3, null);
            }

            public Action(@AbstractC0074Px int i, @AbstractC0074Px int i2, int i3, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@AbstractC0074Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }
            ...
            public void setDy(@AbstractC0074Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@AbstractC0074Px int i, @AbstractC0074Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        @Override // android.support.p003v4.view.AbsSavedState, android.os.Parcelable
    ...
    private class ItemAnimatorRestoreListener implements ItemAnimator.ItemAnimatorListener {
        ...
        @Override // android.support.p006v7.widget.RecyclerView.ItemAnimator.ItemAnimatorListener
