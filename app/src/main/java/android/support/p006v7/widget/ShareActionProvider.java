...
public class ShareActionProvider extends ActionProvider {
    ...
    @Override // android.support.p003v4.view.ActionProvider
    ...
    public View onCreateActionView() {
        ...
        this.mContext.getTheme().resolveAttribute(C0455R.attr.actionModeShareDrawable, typedValue, true);
        ...
        activityChooserView.setDefaultActionButtonContentDescription(C0455R.string.abc_shareactionprovider_share_with_application);
        activityChooserView.setExpandActivityOverflowButtonContentDescription(C0455R.string.abc_shareactionprovider_share_with);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (min < activityCount) {
            SubMenu addSubMenu = subMenu.addSubMenu(0, min, min, this.mContext.getString(C0455R.string.abc_activity_chooser_view_see_all));
    ...
    public class ShareActivityChooserModelPolicy implements ActivityChooserModel.OnChooseActivityListener {
        ...
        @Override // android.support.p006v7.widget.ActivityChooserModel.OnChooseActivityListener
