...
public class ActivityChooserModel extends DataSetObservable {
    ...
    private static final class DefaultSorter implements ActivitySorter {
        ...
        @Override // android.support.p006v7.widget.ActivityChooserModel.ActivitySorter
                    ...
                    while (true) {
                        ...
                        if (next == 1) {
                            ...
                            if (TAG_HISTORICAL_RECORD.equals(newPullParser.getName())) {
                                list.add(new HistoricalRecord(newPullParser.getAttributeValue(null, "activity"), Long.parseLong(newPullParser.getAttributeValue(null, ATTRIBUTE_TIME)), Float.parseFloat(newPullParser.getAttributeValue(null, ATTRIBUTE_WEIGHT))));
                            } else {
    ...
    public final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        */
        public java.lang.Void doInBackground(java.lang.Object... r12) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.ActivityChooserModel.PersistHistoryAsyncTask.doInBackground(java.lang.Object[]):java.lang.Void");
        }
    }
}
