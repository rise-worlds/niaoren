...
import android.support.p003v4.widget.ResourceCursorAdapter;
...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    @Override // android.support.p003v4.widget.CursorAdapter, android.widget.BaseAdapter, android.widget.Adapter
    ...
    @Override // android.support.p003v4.widget.CursorAdapter, android.support.p003v4.widget.CursorFilter.CursorFilterClient
    ...
    @Override // android.support.p003v4.widget.ResourceCursorAdapter, android.support.p003v4.widget.CursorAdapter
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        View newView = super.newView(context, cursor, viewGroup);
        newView.setTag(new ChildViewCache(newView));
        ((ImageView) newView.findViewById(C0455R.C0457id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0455R.C0457id.edit_query);
        }
    }

    @Override // android.support.p003v4.widget.CursorAdapter
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0455R.attr.textColorSearchUrl, typedValue, true);
    ...
    @Override // android.support.p003v4.widget.CursorAdapter, android.widget.Adapter
    ...
    @Override // android.support.p003v4.widget.CursorAdapter, android.widget.BaseAdapter, android.widget.SpinnerAdapter
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        if (str == null || str.isEmpty() || ResultTypeConstant.f7213z.equals(str)) {
            return null;
        }
        try {
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        Uri.Builder fragment = new Uri.Builder().scheme(ServiceManagerNative.CONTENT).authority(suggestAuthority).query("").fragment("");
