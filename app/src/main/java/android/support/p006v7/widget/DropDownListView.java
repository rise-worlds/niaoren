...
import android.support.p003v4.widget.ListViewAutoScrollHelper;
...
public class DropDownListView extends ListView {
    ...
    public DropDownListView(Context context, boolean z) {
        super(context, null, C0455R.attr.dropDownListViewStyle);
        this.mHijackFocus = z;
        setCacheColorHint(0);
        try {
    ...
    public int measureHeightOfChildrenCompat(int i, int i2, int i3, int i4, int i5) {
        ...
        while (i8 < count) {
            ...
            if (layoutParams.height > 0) {
                i6 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, MemoryConstants.f21646d);
            } else {
    ...
    public static class GateKeeperDrawable extends DrawableWrapper {
        ...
        @Override // android.support.p006v7.graphics.drawable.DrawableWrapper, android.graphics.drawable.Drawable
    ...
    */
    public boolean onForwardedEvent(android.view.MotionEvent r8, int r9) {
        ...
        L_0x006a:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.DropDownListView.onForwardedEvent(android.view.MotionEvent, int):boolean");
    }
