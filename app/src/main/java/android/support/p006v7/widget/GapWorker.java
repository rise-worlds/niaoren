...
public final class GapWorker implements Runnable {
    ...
    public static class LayoutPrefetchRegistryImpl implements RecyclerView.LayoutManager.LayoutPrefetchRegistry {
        ...
        @Override // android.support.p006v7.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry
    ...
    private void flushTaskWithDeadline(Task task, long j) {
        RecyclerView.ViewHolder prefetchPositionWithDeadline = prefetchPositionWithDeadline(task.view, task.position, task.immediate ? cjm.f20759b : j);
