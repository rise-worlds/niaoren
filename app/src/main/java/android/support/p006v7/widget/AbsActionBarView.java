...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0455R.attr.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0455R.styleable.ActionBar, C0455R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0455R.styleable.ActionBar_height, 0));
    ...
    public class VisibilityAnimListener implements ViewPropertyAnimatorListener {
        ...
        @Override // android.support.p003v4.view.ViewPropertyAnimatorListener
