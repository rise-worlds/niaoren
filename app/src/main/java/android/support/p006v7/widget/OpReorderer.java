...
class OpReorderer {
    ...
    */
    void swapMoveUpdate(java.util.List<android.support.p006v7.widget.AdapterHelper.UpdateOp> r8, int r9, android.support.p006v7.widget.AdapterHelper.UpdateOp r10, int r11, android.support.p006v7.widget.AdapterHelper.UpdateOp r12) {
        /*
            r7 = this;
        ...
        L_0x0073:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.OpReorderer.swapMoveUpdate(java.util.List, int, android.support.v7.widget.AdapterHelper$UpdateOp, int, android.support.v7.widget.AdapterHelper$UpdateOp):void");
    }
