...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    @Override // android.support.p006v7.widget.LinearLayoutManager
    ...
    */
    void layoutChunk(android.support.p006v7.widget.RecyclerView.Recycler r19, android.support.p006v7.widget.RecyclerView.State r20, android.support.p006v7.widget.LinearLayoutManager.LayoutState r21, android.support.p006v7.widget.LinearLayoutManager.LayoutChunkResult r22) {
        /*
            Method dump skipped, instructions count: 587
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.GridLayoutManager.layoutChunk(android.support.v7.widget.RecyclerView$Recycler, android.support.v7.widget.RecyclerView$State, android.support.v7.widget.LinearLayoutManager$LayoutState, android.support.v7.widget.LinearLayoutManager$LayoutChunkResult):void");
    }
            ...
            if (!childAt.hasFocusable() || spanGroupIndex2 == spanGroupIndex) {
                ...
                if (z) {
                    if (childAt.hasFocusable()) {
                        ...
                        i8 = Math.min(i12, i6) - Math.max(i11, i5);
                        view4 = view4;
                        i7 = i13;
                        i10 = i10;
                        view3 = childAt;
