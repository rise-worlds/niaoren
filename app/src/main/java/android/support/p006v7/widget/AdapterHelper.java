...
import android.support.p006v7.widget.OpReorderer;
...
public class AdapterHelper implements OpReorderer.Callback {
    ...
    private void dispatchAndUpdateViewHolders(UpdateOp updateOp) {
        ...
        for (int i6 = 1; i6 < updateOp.itemCount; i6++) {
            ...
            int i7 = updateOp.cmd;
            if (i7 != 2 ? i7 != 4 ? false : updatePositionWithPostponed2 == updatePositionWithPostponed + 1 : updatePositionWithPostponed2 == updatePositionWithPostponed) {
                i5++;
            } else {
    ...
    */
    public int applyPendingUpdatesToPosition(int r6) {
        ...
        L_0x0007:
            ...
            android.support.v7.widget.AdapterHelper$UpdateOp r2 = (android.support.p006v7.widget.AdapterHelper.UpdateOp) r2
            int r3 = r2.cmd
            r4 = 8
        ...
        L_0x004a:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.AdapterHelper.applyPendingUpdatesToPosition(int):int");
    }
    ...
    @Override // android.support.p006v7.widget.OpReorderer.Callback
