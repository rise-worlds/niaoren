    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0455R.C0457id.topPanel) {
                    view = childAt;
                } else if (id == C0455R.C0457id.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0455R.C0457id.contentPanel && id != C0455R.C0457id.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            ...
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(i5, MemoryConstants.f21646d));
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (!(childAt == null || childAt.getVisibility() == 8)) {
                ...
                int i11 = i5 + layoutParams.topMargin;
                setChildFrame(childAt, i6, i11, measuredWidth, measuredHeight2);
                i5 = i11 + measuredHeight2 + layoutParams.bottomMargin;
            }
        }
    }
