...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    */
    private void onMeasureExactFormat(int r30, int r31) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.ActionMenuView.onMeasureExactFormat(int, int):void");
    }
    ...
    public static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(View.MeasureSpec.makeMeasureSpec(i * i5, MemoryConstants.f21646d), makeMeasureSpec);
        return i5;
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // android.support.p006v7.widget.LinearLayoutCompat, android.view.ViewGroup
    ...
    @Override // android.support.p006v7.view.menu.MenuBuilder.ItemInvoker
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
