...
import android.support.p006v7.view.menu.ActionMenuItemView;
import android.support.p006v7.view.menu.BaseMenuPresenter;
...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0455R.layout.abc_action_menu_layout, C0455R.layout.abc_action_menu_item_layout);
    }

    @Override // android.support.p006v7.view.menu.BaseMenuPresenter, android.support.p006v7.view.menu.MenuPresenter
    ...
    @Override // android.support.p006v7.view.menu.BaseMenuPresenter
    ...
    public boolean flagActionItems() {
        ...
        while (i14 < i) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (actionMenuPresenter.mStrictWidthLimit) {
                    i2 -= ActionMenuView.measureChildForCells(itemView, i3, i2, makeMeasureSpec, i4);
                } else {
                    itemView.measure(makeMeasureSpec, makeMeasureSpec);
                }
                i15 = itemView.getMeasuredWidth();
                i13 -= i15;
                if (i15 != 0) {
                    i15 = i15;
                }
                ...
                boolean z4 = (i11 > 0 || z3) && i13 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i2 > 0);
                if (z4) {
                    boolean z5 = z4;
    ...
    @Override // android.support.p003v4.view.ActionProvider.SubUiVisibilityListener
    ...
    public class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        ...
        @Override // android.support.p006v7.widget.ActionMenuView.ActionMenuChildView
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0455R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    public class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z) {
            super(context, menuBuilder, view, z, C0455R.attr.actionOverflowMenuStyle);
            setGravity(GravityCompat.END);
            setPresenterCallback(ActionMenuPresenter.this.mPopupPresenterCallback);
        }

        @Override // android.support.p006v7.view.menu.MenuPopupHelper
    ...
    public class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenuBuilder, View view) {
            super(context, subMenuBuilder, view, false, C0455R.attr.actionOverflowMenuStyle);
    ...
    private class ActionMenuPopupCallback extends ActionMenuItemView.PopupCallback {
        ...
        @Override // android.support.p006v7.view.menu.ActionMenuItemView.PopupCallback
        public ShowableListMenu getPopup() {
