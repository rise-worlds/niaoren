...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    @Override // android.support.p006v7.widget.RecyclerView.LayoutManager
    ...
    */
    private void onLayoutChildren(android.support.p006v7.widget.RecyclerView.Recycler r9, android.support.p006v7.widget.RecyclerView.State r10, boolean r11) {
        /*
            Method dump skipped, instructions count: 389
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.StaggeredGridLayoutManager.onLayoutChildren(android.support.v7.widget.RecyclerView$Recycler, android.support.v7.widget.RecyclerView$State, boolean):void");
    }
        ...
        while (true) {
            if (layoutState.hasMore(state)) {
                ...
                if (layoutState.mLayoutDirection == 1) {
                    ...
                    i5 = this.mPrimaryOrientation.getDecoratedMeasurement(next) + i11;
                    ...
                    i6 = i10 - this.mPrimaryOrientation.getDecoratedMeasurement(next);
                    if (z4 && layoutParams.mFullSpan) {
                ...
                if (!isLayoutRTL() || this.mOrientation != 1) {
                    ...
                    i8 = endAfterPadding - this.mSecondaryOrientation.getDecoratedMeasurement(next);
                    i7 = endAfterPadding;
                }
                if (this.mOrientation == 1) {
    ...
    @Override // android.support.p006v7.widget.RecyclerView.SmoothScroller.ScrollVectorProvider
