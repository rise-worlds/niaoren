...
import android.support.p003v4.widget.TintableCompoundButton;
...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton {
    ...
    public AppCompatRadioButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0455R.attr.radioButtonStyle);
    }
    ...
    @Override // android.support.p003v4.widget.TintableCompoundButton
