...
import android.support.p006v7.view.menu.ShowableListMenu;
import android.support.p006v7.widget.ActivityChooserModel;
...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0455R.styleable.ActivityChooserView, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0455R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0455R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0455R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = findViewById(C0455R.C0457id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0455R.C0457id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0455R.C0457id.image);
        FrameLayout frameLayout = (FrameLayout) findViewById(C0455R.C0457id.expand_activities_button);
        ...
        frameLayout.setOnTouchListener(new ForwardingListener(frameLayout) { // from class: android.support.v7.widget.ActivityChooserView.4
            @Override // android.support.p006v7.widget.ForwardingListener
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C0455R.C0457id.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0455R.dimen.abc_config_prefDialogWidth));
    }

    @Override // android.support.p006v7.widget.ActivityChooserModel.ActivityChooserModelClient
    ...
    */
    void showPopupUnchecked(int r6) {
        ...
        L_0x0078:
            ...
            int r3 = android.support.p006v7.appcompat.C0455R.string.abc_activitychooserview_choose_application
        ...
        L_0x0096:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.ActivityChooserView.showPopupUnchecked(int):void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mDefaultActivityButton.getVisibility() != 0) {
            i2 = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), MemoryConstants.f21646d);
        }
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            switch (getItemViewType(i)) {
                case 0:
                    if (view == null || view.getId() != C0455R.C0457id.list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0455R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                    ((ImageView) view.findViewById(C0455R.C0457id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                    ((TextView) view.findViewById(C0455R.C0457id.title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                case 1:
                    ...
                    View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0455R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    inflate.setId(1);
                    ((TextView) inflate.findViewById(C0455R.C0457id.title)).setText(ActivityChooserView.this.getContext().getString(C0455R.string.abc_activity_chooser_view_see_all));
                    return inflate;
                default:
                    throw new IllegalArgumentException();
            }
