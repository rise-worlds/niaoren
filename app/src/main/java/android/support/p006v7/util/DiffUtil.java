package android.support.p006v7.util;
...
public class DiffUtil {
    ...
    public static DiffResult calculateDiff(@NonNull Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (diffPartial != null) {
                ...
                if (!diffPartial.reverse) {
                    range.oldListStart = diffPartial.f41x + diffPartial.size;
                    range.newListStart = diffPartial.f42y + diffPartial.size;
                } else if (diffPartial.removal) {
                    range.oldListStart = diffPartial.f41x + diffPartial.size + 1;
                    range.newListStart = diffPartial.f42y + diffPartial.size;
                } else {
                    range.oldListStart = diffPartial.f41x + diffPartial.size;
                    range.newListStart = diffPartial.f42y + diffPartial.size + 1;
                }
    ...
    */
    private static android.support.p006v7.util.DiffUtil.Snake diffPartial(android.support.p006v7.util.DiffUtil.Callback r19, int r20, int r21, int r22, int r23, int[] r24, int[] r25, int r26) {
        /*
            Method dump skipped, instructions count: 313
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.util.DiffUtil.diffPartial(android.support.v7.util.DiffUtil$Callback, int, int, int, int, int[], int[], int):android.support.v7.util.DiffUtil$Snake");
    }
    ...
    public static class DiffResult {
        ...
        private void findMatchingItems() {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                int i3 = snake.f41x + snake.size;
                int i4 = snake.f42y + snake.size;
                ...
                for (int i5 = 0; i5 < snake.size; i5++) {
                    int i6 = snake.f41x + i5;
                    int i7 = snake.f42y + i5;
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i6 = snake.f41x + snake.size;
                int i7 = snake.f42y + snake.size;
                int i8 = 8;
                if (z) {
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                for (int i7 = i4 - 1; i7 >= 0; i7--) {
                    if ((this.mOldItemStatuses[snake.f41x + i7] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(snake.f41x + i7, 1, this.mCallback.getChangePayload(snake.f41x + i7, snake.f42y + i7));
                    }
                }
                i = snake.f41x;
                i3 = snake.f42y;
        ...
        private void dispatchAdditions(List<PostponedUpdate> list, ListUpdateCallback listUpdateCallback, int i, int i2, int i3) {
            ...
            for (int i4 = i2 - 1; i4 >= 0; i4--) {
                ...
                if (i6 == 0) {
                    ...
                    throw new IllegalStateException("unknown flag for pos " + i5 + ExpandableTextView.f6958c + Long.toBinaryString(i6));
                }
            }
        }
