...
import android.support.p006v7.util.ThreadUtil;
import android.support.p006v7.util.TileList;
...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C04701 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.1.1
            ...
            public void run() {
                ...
                while (next != null) {
                    switch (next.what) {
                        case 1:
                            C04701.this.val$callback.updateItemCount(next.arg1, next.arg2);
                            break;
                        case 2:
                            C04701.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                            break;
                        case 3:
                            C04701.this.val$callback.removeTile(next.arg1, next.arg2);
                            break;
                        default:
        ...
        @Override // android.support.p006v7.util.ThreadUtil.MainThreadCallback
    ...
    @Override // android.support.p006v7.util.ThreadUtil
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C04701(mainThreadCallback);
    }
    ...
    class C04722 implements ThreadUtil.BackgroundCallback<T> {
                    ...
                    if (next != null) {
                        switch (next.what) {
                            case 1:
                                ...
                                C04722.this.val$callback.refresh(next.arg1);
                                break;
                            case 2:
                                C04722.this.mQueue.removeMessages(2);
                                C04722.this.mQueue.removeMessages(3);
                                C04722.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                                break;
                            case 3:
                                C04722.this.val$callback.loadTile(next.arg1, next.arg2);
                                break;
                            case 4:
                                C04722.this.val$callback.recycleTile((TileList.Tile) next.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                                break;
        ...
        @Override // android.support.p006v7.util.ThreadUtil.BackgroundCallback
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C04722(backgroundCallback);
    }
