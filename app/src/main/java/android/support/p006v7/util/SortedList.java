...
public class SortedList<T> {
    ...
    public static class BatchedCallback<T2> extends Callback<T2> {
        ...
        @Override // android.support.p006v7.util.SortedList.Callback, java.util.Comparator
        ...
        @Override // android.support.p006v7.util.SortedList.Callback
        public void onChanged(int i, int i2) {
            this.mBatchingListUpdateCallback.onChanged(i, i2, null);
        }

        @Override // android.support.p006v7.util.SortedList.Callback, android.support.p006v7.util.ListUpdateCallback
        public void onChanged(int i, int i2, Object obj) {
