...
import android.support.p006v7.app.AlertController;
...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    static int resolveDialogTheme(@NonNull Context context, @StyleRes int i) {
        ...
        context.getTheme().resolveAttribute(C0455R.attr.alertDialogTheme, typedValue, true);
    ...
    public static class Builder {
        ...
        public AlertDialog create() {
            ...
            if (this.f32P.mOnKeyListener != null) {
                alertDialog.setOnKeyListener(this.f32P.mOnKeyListener);
            }
            return alertDialog;
        }
