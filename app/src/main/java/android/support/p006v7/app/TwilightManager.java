...
import android.support.p003v4.content.PermissionChecker;
...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        instance.calculateTwilight(currentTimeMillis - WaitFor.ONE_DAY, location.getLatitude(), location.getLongitude());
        ...
        instance.calculateTwilight(WaitFor.ONE_DAY + currentTimeMillis, location.getLatitude(), location.getLongitude());
        long j5 = instance.sunrise;
        if (j3 == -1 || j4 == -1) {
            j = 43200000 + currentTimeMillis;
        } else {
            j = (currentTimeMillis > j4 ? 0 + j5 : currentTimeMillis > j3 ? 0 + j4 : 0 + j3) + WaitFor.ONE_MINUTE;
        }
