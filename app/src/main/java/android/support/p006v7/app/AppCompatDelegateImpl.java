...
import android.support.p003v4.app.NavUtils;
import android.support.p003v4.view.KeyEventDispatcher;
import android.support.p003v4.view.LayoutInflaterCompat;
import android.support.p003v4.view.OnApplyWindowInsetsListener;
import android.support.p003v4.view.ViewCompat;
import android.support.p003v4.view.ViewPropertyAnimatorCompat;
import android.support.p003v4.view.ViewPropertyAnimatorListenerAdapter;
import android.support.p003v4.view.WindowInsetsCompat;
import android.support.p006v7.app.ActionBarDrawerToggle;
import android.support.p006v7.appcompat.C0455R;
import android.support.p006v7.content.res.AppCompatResources;
import android.support.p006v7.view.ActionMode;
import android.support.p006v7.view.ContextThemeWrapper;
import android.support.p006v7.view.SupportActionModeWrapper;
import android.support.p006v7.view.SupportMenuInflater;
import android.support.p006v7.view.WindowCallbackWrapper;
import android.support.p006v7.view.menu.ListMenuPresenter;
import android.support.p006v7.view.menu.MenuBuilder;
import android.support.p006v7.view.menu.MenuPresenter;
import android.support.p006v7.view.menu.MenuView;
import android.support.p006v7.widget.ActionBarContextView;
import android.support.p006v7.widget.AppCompatDrawableManager;
import android.support.p006v7.widget.ContentFrameLayout;
import android.support.p006v7.widget.DecorContentParent;
import android.support.p006v7.widget.FitWindowsViewGroup;
import android.support.p006v7.widget.TintTypedArray;
import android.support.p006v7.widget.Toolbar;
import android.support.p006v7.widget.VectorEnabledTintResources;
import android.support.p006v7.widget.ViewUtils;
...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    @Override // android.support.p006v7.app.AppCompatDelegate
    ...
    private ViewGroup createSubDecor() {
        ViewGroup viewGroup;
        Context context;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0455R.styleable.AppCompatTheme);
        if (obtainStyledAttributes.hasValue(C0455R.styleable.AppCompatTheme_windowActionBar)) {
            if (obtainStyledAttributes.getBoolean(C0455R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (obtainStyledAttributes.getBoolean(C0455R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(108);
            }
            if (obtainStyledAttributes.getBoolean(C0455R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(109);
            }
            if (obtainStyledAttributes.getBoolean(C0455R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = obtainStyledAttributes.getBoolean(C0455R.styleable.AppCompatTheme_android_windowIsFloating, false);
            obtainStyledAttributes.recycle();
            this.mWindow.getDecorView();
            LayoutInflater from = LayoutInflater.from(this.mContext);
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    viewGroup = (ViewGroup) from.inflate(C0455R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
                } else {
                    viewGroup = (ViewGroup) from.inflate(C0455R.layout.abc_screen_simple, (ViewGroup) null);
                }
                if (Build.VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(viewGroup, new OnApplyWindowInsetsListener() { // from class: android.support.v7.app.AppCompatDelegateImpl.3
                        @Override // android.support.p003v4.view.OnApplyWindowInsetsListener
                    ...
                    ((FitWindowsViewGroup) viewGroup).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener() { // from class: android.support.v7.app.AppCompatDelegateImpl.4
                        @Override // android.support.p006v7.widget.FitWindowsViewGroup.OnFitSystemWindowsListener
                ...
                viewGroup = (ViewGroup) from.inflate(C0455R.layout.abc_dialog_title_material, (ViewGroup) null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0455R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    context = new ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    context = this.mContext;
                }
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0455R.layout.abc_screen_toolbar, (ViewGroup) null);
                this.mDecorContentParent = (DecorContentParent) viewGroup.findViewById(C0455R.C0457id.decor_content_parent);
            ...
            if (viewGroup != null) {
                if (this.mDecorContentParent == null) {
                    this.mTitleView = (TextView) viewGroup.findViewById(C0455R.C0457id.title);
                }
                ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
                ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0455R.C0457id.action_bar_activity_content);
                ...
                contentFrameLayout.setAttachListener(new ContentFrameLayout.OnAttachListener() { // from class: android.support.v7.app.AppCompatDelegateImpl.5
                    @Override // android.support.p006v7.widget.ContentFrameLayout.OnAttachListener
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0455R.styleable.AppCompatTheme);
        obtainStyledAttributes.getValue(C0455R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        obtainStyledAttributes.getValue(C0455R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (obtainStyledAttributes.hasValue(C0455R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            obtainStyledAttributes.getValue(C0455R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (obtainStyledAttributes.hasValue(C0455R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            obtainStyledAttributes.getValue(C0455R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (obtainStyledAttributes.hasValue(C0455R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            obtainStyledAttributes.getValue(C0455R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (obtainStyledAttributes.hasValue(C0455R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            obtainStyledAttributes.getValue(C0455R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        obtainStyledAttributes.recycle();
    ...
    @Override // android.support.p006v7.view.menu.MenuBuilder.Callback
    ...
    */
    android.support.p006v7.view.ActionMode startSupportActionModeFromWindow(@android.support.annotation.NonNull android.support.p006v7.view.ActionMode.Callback r8) {
        /*
            Method dump skipped, instructions count: 372
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.app.AppCompatDelegateImpl.startSupportActionModeFromWindow(android.support.v7.view.ActionMode$Callback):android.support.v7.view.ActionMode");
    }
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String string = this.mContext.obtainStyledAttributes(C0455R.styleable.AppCompatTheme).getString(C0455R.styleable.AppCompatTheme_viewInflaterClass);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0455R.attr.actionBarTheme, typedValue, true);
            Resources.Theme theme2 = null;
            if (typedValue.resourceId != 0) {
                theme2 = context.getResources().newTheme();
                theme2.setTo(theme);
                theme2.applyStyle(typedValue.resourceId, true);
                theme2.resolveAttribute(C0455R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0455R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context.getResources().newTheme();
    ...
    */
    private boolean onKeyUpPanel(int r4, android.view.KeyEvent r5) {
        ...
        L_0x0083:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.app.AppCompatDelegateImpl.onKeyUpPanel(int, android.view.KeyEvent):boolean");
    }
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (view == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0455R.color.abc_input_method_navigation_guard));
    ...
    public class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        @Override // android.support.p006v7.view.ActionMode.Callback
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImpl.this.mActionModeView != null) {
                ...
                AppCompatDelegateImpl.this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: android.support.v7.app.AppCompatDelegateImpl.ActionModeCallbackWrapperV9.1
                    @Override // android.support.p003v4.view.ViewPropertyAnimatorListenerAdapter, android.support.p003v4.view.ViewPropertyAnimatorListener
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        @Override // android.support.p006v7.view.menu.MenuPresenter.Callback
    ...
    public static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            newTheme.resolveAttribute(C0455R.attr.actionBarPopupTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            }
            newTheme.resolveAttribute(C0455R.attr.panelMenuListTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            } else {
                newTheme.applyStyle(C0455R.style.Theme_AppCompat_CompactMenu, true);
            }
            ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(newTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0455R.styleable.AppCompatTheme);
            this.background = obtainStyledAttributes.getResourceId(C0455R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = obtainStyledAttributes.getResourceId(C0455R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            obtainStyledAttributes.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0455R.layout.abc_list_menu_item_layout);
    ...
    class AppCompatWindowCallback extends WindowCallbackWrapper {
        @Override // android.support.p006v7.view.WindowCallbackWrapper, android.view.Window.Callback
        ...
        final android.view.ActionMode startAsSupportActionMode(ActionMode.Callback callback) {
            ...
            android.support.p006v7.view.ActionMode startSupportActionMode = AppCompatDelegateImpl.this.startSupportActionMode(callbackWrapper);
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        @Override // android.support.p006v7.app.ActionBarDrawerToggle.Delegate
        public Drawable getThemeUpIndicator() {
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0455R.attr.homeAsUpIndicator});
