...
class TransitionUtils {
    ...
    public static View copyViewImage(ViewGroup viewGroup, View view, View view2) {
        ...
        imageView.measure(View.MeasureSpec.makeMeasureSpec(round3 - round, MemoryConstants.f21646d), View.MeasureSpec.makeMeasureSpec(round4 - round2, MemoryConstants.f21646d));
