...
class ImageViewUtils {
    ...
    public static void startAnimateTransform(ImageView imageView) {
        if (Build.VERSION.SDK_INT < 21) {
            ...
            imageView.setTag(C0243R.C0245id.save_scale_type, scaleType);
            if (scaleType == ImageView.ScaleType.MATRIX) {
                imageView.setTag(C0243R.C0245id.save_image_matrix, imageView.getImageMatrix());
            } else {
        ...
        if (Build.VERSION.SDK_INT < 21) {
            animator.addListener(new AnimatorListenerAdapter() { // from class: android.support.transition.ImageViewUtils.1
                ...
                public void onAnimationEnd(Animator animator2) {
                    ImageView.ScaleType scaleType = (ImageView.ScaleType) imageView.getTag(C0243R.C0245id.save_scale_type);
                    imageView.setScaleType(scaleType);
                    imageView.setTag(C0243R.C0245id.save_scale_type, null);
                    if (scaleType == ImageView.ScaleType.MATRIX) {
                        ImageView imageView2 = imageView;
                        imageView2.setImageMatrix((Matrix) imageView2.getTag(C0243R.C0245id.save_image_matrix));
                        imageView.setTag(C0243R.C0245id.save_image_matrix, null);
                    }
