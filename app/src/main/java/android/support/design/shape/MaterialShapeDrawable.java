...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable {
    ...
    @Override // android.graphics.drawable.Drawable
    public void setAlpha(@IntRange(from = 0, m25695to = 255) int i) {
        this.alpha = i;
        invalidateSelf();
    }
    ...
    private void appendEdgePath(int i, Path path) {
        ...
        getEdgeTreatmentForIndex(i).getEdgePath((float) Math.hypot(f - fArr2[0], fArr[1] - fArr2[1]), this.interpolation, this.shapePath);
