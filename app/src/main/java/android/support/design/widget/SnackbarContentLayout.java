...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.maxWidth = obtainStyledAttributes.getDimensionPixelSize(C0101R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.maxInlineActionWidth = obtainStyledAttributes.getDimensionPixelSize(C0101R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    protected void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C0101R.C0103id.snackbar_text);
        this.actionView = (Button) findViewById(C0101R.C0103id.snackbar_action);
    }
    ...
    */
    protected void onMeasure(int r8, int r9) {
        ...
        L_0x0018:
            ...
            int r1 = android.support.design.C0101R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r1)
            android.content.res.Resources r1 = r7.getResources()
            int r2 = android.support.design.C0101R.dimen.design_snackbar_padding_vertical
