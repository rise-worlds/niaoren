...
import android.support.p003v4.view.accessibility.AccessibilityManagerCompat;
...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static {
        ...
        SNACKBAR_STYLE_ATTR = new int[]{C0101R.attr.snackbarStyle};
    ...
    protected int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C0101R.layout.mtrl_layout_snackbar : C0101R.layout.design_layout_snackbar;
    }
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0101R.styleable.SnackbarLayout);
            if (obtainStyledAttributes.hasValue(C0101R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, obtainStyledAttributes.getDimensionPixelSize(C0101R.styleable.SnackbarLayout_elevation, 0));
            }
            obtainStyledAttributes.recycle();
            ...
            this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: android.support.design.widget.BaseTransientBottomBar.SnackbarBaseLayout.1
                @Override // android.support.p003v4.view.accessibility.AccessibilityManagerCompat.TouchExplorationStateChangeListener
