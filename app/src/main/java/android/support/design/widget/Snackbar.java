...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0101R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(findSuitableParent.getContext()).inflate(hasSnackbarButtonStyleAttr(findSuitableParent.getContext()) ? C0101R.layout.mtrl_layout_snackbar_include : C0101R.layout.design_layout_snackbar_include, findSuitableParent, false);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (childAt.getLayoutParams().width == -1) {
                    childAt.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, MemoryConstants.f21646d), View.MeasureSpec.makeMeasureSpec(childAt.getMeasuredHeight(), MemoryConstants.f21646d));
                }
            }
        }
    }
