...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0101R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C0101R.C0102drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0101R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0101R.C0103id.icon);
        this.smallLabel = (TextView) findViewById(C0101R.C0103id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0101R.C0103id.largeLabel);
    ...
    @Override // android.view.View, android.support.p006v7.view.menu.MenuView.ItemView
