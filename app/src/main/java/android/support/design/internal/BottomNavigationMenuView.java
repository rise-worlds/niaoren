...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    @Override // android.support.p006v7.view.menu.MenuView
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.inactiveItemMaxWidth = resources.getDimensionPixelSize(C0101R.dimen.design_bottom_navigation_item_max_width);
        this.inactiveItemMinWidth = resources.getDimensionPixelSize(C0101R.dimen.design_bottom_navigation_item_min_width);
        this.activeItemMaxWidth = resources.getDimensionPixelSize(C0101R.dimen.design_bottom_navigation_active_item_max_width);
        this.activeItemMinWidth = resources.getDimensionPixelSize(C0101R.dimen.design_bottom_navigation_active_item_min_width);
        this.itemHeight = resources.getDimensionPixelSize(C0101R.dimen.design_bottom_navigation_height);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.itemHeight, MemoryConstants.f21646d);
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths[i11], MemoryConstants.f21646d), makeMeasureSpec);
                childAt2.getLayoutParams().width = childAt2.getMeasuredWidth();
                i10 += childAt2.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(i10, View.MeasureSpec.makeMeasureSpec(i10, MemoryConstants.f21646d), 0), View.resolveSizeAndState(this.itemHeight, makeMeasureSpec, 0));
    }
