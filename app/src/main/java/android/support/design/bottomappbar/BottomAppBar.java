...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    @Override // android.support.p006v7.widget.Toolbar
    ...
    public BottomAppBar(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0101R.attr.bottomAppBarStyle);
    }
    ...
    public BottomAppBar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0101R.styleable.BottomAppBar, i, C0101R.style.Widget_MaterialComponents_BottomAppBar, new int[0]);
        ColorStateList colorStateList = MaterialResources.getColorStateList(context, obtainStyledAttributes, C0101R.styleable.BottomAppBar_backgroundTint);
        this.fabAlignmentMode = obtainStyledAttributes.getInt(C0101R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.hideOnScroll = obtainStyledAttributes.getBoolean(C0101R.styleable.BottomAppBar_hideOnScroll, false);
        obtainStyledAttributes.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C0101R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
        this.topEdgeTreatment = new BottomAppBarTopEdgeTreatment(obtainStyledAttributes.getDimensionPixelOffset(C0101R.styleable.BottomAppBar_fabCradleMargin, 0), obtainStyledAttributes.getDimensionPixelOffset(C0101R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0), obtainStyledAttributes.getDimensionPixelOffset(C0101R.styleable.BottomAppBar_fabCradleVerticalOffset, 0));
    ...
    void setFabDiameter(@AbstractC0074Px int i) {
        float f = i;
    ...
    private float getFabTranslationY(boolean z) {
        ...
        r0 = (-getCradleVerticalOffset()) + (height / 2.0f) + (findDependentFab.getHeight() - rect.bottom);
    ...
    @Override // android.support.p006v7.widget.Toolbar, android.view.ViewGroup, android.view.View
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // android.support.p006v7.widget.Toolbar, android.view.View
