...
import android.support.p003v4.widget.ExploreByTouchHelper;
...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate {
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0101R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        ChipDrawable createFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, i, C0101R.style.Widget_MaterialComponents_Chip_Action);
    ...
    public class ChipTouchHelper extends ExploreByTouchHelper {
        ...
        @Override // android.support.p003v4.widget.ExploreByTouchHelper
        ...
        protected void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (Chip.this.hasCloseIcon()) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i2 = C0101R.string.mtrl_chip_close_icon_content_description;
