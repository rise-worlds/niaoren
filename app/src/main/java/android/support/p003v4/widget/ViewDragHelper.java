...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
        ...
        public void onViewPositionChanged(@NonNull View view, int i, int i2, @AbstractC0074Px int i3, @AbstractC0074Px int i4) {
        }
    ...
    */
    public boolean shouldInterceptTouchEvent(@android.support.annotation.NonNull android.view.MotionEvent r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v4.widget.ViewDragHelper.shouldInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
