...
import android.support.p003v4.view.NestedScrollingParent;
...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    public void setSlingshotDistance(@AbstractC0074Px int i) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        View view = this.mTarget;
        if (view != null) {
            view.measure(View.MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), MemoryConstants.f21646d), View.MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), MemoryConstants.f21646d));
            this.mCircleView.measure(View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, MemoryConstants.f21646d), View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, MemoryConstants.f21646d));
            this.mCircleViewIndex = -1;
