...
import android.support.p003v4.widget.ViewDragHelper;
...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public static class SimplePanelSlideListener implements PanelSlideListener {
        @Override // android.support.p003v4.widget.SlidingPaneLayout.PanelSlideListener
    ...
    public void setParallaxDistance(@AbstractC0074Px int i) {
        this.mParallaxBy = i;
        requestLayout();
    }
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    i9 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i13, MemoryConstants.f21646d);
                } else {
                    i9 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, MemoryConstants.f21646d);
                }
                if (layoutParams.height == -2) {
                    i10 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    i10 = View.MeasureSpec.makeMeasureSpec(i3, MemoryConstants.f21646d);
                } else {
                    i10 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, MemoryConstants.f21646d);
                }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    i6 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), MemoryConstants.f21646d);
                                } else if (layoutParams2.height == -2) {
                                    i6 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                } else if (layoutParams2.height == -1) {
                                    i6 = View.MeasureSpec.makeMeasureSpec(i3, MemoryConstants.f21646d);
                                } else {
                                    i6 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, MemoryConstants.f21646d);
                                }
                                if (z2) {
                                    int i16 = paddingLeft - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                    i14 = i14;
                                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i16, MemoryConstants.f21646d);
                                    if (measuredWidth2 != i16) {
                                        childAt2.measure(makeMeasureSpec, i6);
                                    }
                                } else {
                                    i14 = i14;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i11)) / f)), MemoryConstants.f21646d), i6);
                                }
                            } else {
                                i14 = i14;
                            }
                            ...
                            if (!z4) {
                                i7 = MemoryConstants.f21646d;
                                i8 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), MemoryConstants.f21646d);
                            } else if (layoutParams2.height == -2) {
                                i8 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                i7 = MemoryConstants.f21646d;
                            } else if (layoutParams2.height == -1) {
                                i7 = MemoryConstants.f21646d;
                                i8 = View.MeasureSpec.makeMeasureSpec(i3, MemoryConstants.f21646d);
                            } else {
                                i7 = MemoryConstants.f21646d;
                                i8 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, MemoryConstants.f21646d);
                            }
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    i5 = (int) ((1.0f - this.mSlideOffset) * i9);
                    i6 = paddingRight;
                }
                if (isLayoutRtlSupport) {
                    i7 = (i10 - i6) + i5;
    ...
    */
    private void parallaxOtherViews(float r10) {
        /*
            ...
            android.support.v4.widget.SlidingPaneLayout$LayoutParams r1 = (android.support.p003v4.widget.SlidingPaneLayout.LayoutParams) r1
        ...
        L_0x005b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v4.widget.SlidingPaneLayout.parallaxOtherViews(float):void");
    }
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        @Override // android.support.p003v4.widget.ViewDragHelper.Callback
