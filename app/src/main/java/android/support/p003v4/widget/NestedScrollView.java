...
import android.support.p003v4.view.accessibility.AccessibilityRecordCompat;
...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent2, ScrollingView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(i2) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                childAt.measure(getChildMeasureSpec(i, getPaddingLeft() + getPaddingRight() + layoutParams.leftMargin + layoutParams.rightMargin, layoutParams.width), View.MeasureSpec.makeMeasureSpec(measuredHeight2, MemoryConstants.f21646d));
            }
        }
    }
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.scrollPosition + C4963cj.f20747d;
        }
    }
