...
import android.support.p003v4.app.FragmentManagerImpl;
import android.support.p003v4.util.LogWriter;
...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    ArrayList<C0270Op> mOps = new ArrayList<>();
    ...
    /* loaded from: classes.dex */
    public static final class C0270Op {
        int cmd;
        int enterAnim;
        int exitAnim;
        Fragment fragment;
        ...
        C0270Op(int i, Fragment fragment) {
            this.cmd = i;
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                printWriter.print(ExpandableTextView.f6958c);
    ...
    @Override // android.support.p003v4.app.FragmentManager.BackStackEntry
    public int getId() {
        return this.mIndex;
    }
    ...
    @Override // android.support.p003v4.app.FragmentTransaction
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0270Op(3, fragment));
        return this;
    }

    @Override // android.support.p003v4.app.FragmentTransaction
    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0270Op(4, fragment));
        return this;
    }

    @Override // android.support.p003v4.app.FragmentTransaction
    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0270Op(5, fragment));
        return this;
    }

    @Override // android.support.p003v4.app.FragmentTransaction
    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0270Op(6, fragment));
        return this;
    }

    @Override // android.support.p003v4.app.FragmentTransaction
    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0270Op(7, fragment));
        return this;
    }

    @Override // android.support.p003v4.app.FragmentTransaction
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0270Op(8, fragment));
        return this;
    }
    ...
    @Override // android.support.p003v4.app.FragmentManagerImpl.OpGenerator
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        C0270Op op2 = backStackRecord.mOps.get(i7);
            ...
            switch (op.cmd) {
                        ...
                        if (fragment5.mContainerId == i2) {
                            if (fragment5 == fragment3) {
                                ...
                                if (fragment5 == fragment4) {
                                    this.mOps.add(i3, new C0270Op(9, fragment5));
                                    i3++;
                                    fragment4 = null;
                                }
                                C0270Op op2 = new C0270Op(3, fragment5);
                ...
                case 6:
                    ...
                    if (op.fragment == fragment2) {
                        this.mOps.add(i, new C0270Op(9, op.fragment));
                        i++;
                        fragment2 = null;
                        break;
                    } else {
                ...
                case 8:
                    this.mOps.add(i, new C0270Op(9, fragment2));
                    i++;
    ...
    private static boolean isFragmentPostponed(C0270Op op) {
        Fragment fragment = op.fragment;
