...
import android.support.p003v4.app.INotificationSideChannel;
...
public final class NotificationManagerCompat {
    ...
    private NotificationManagerCompat(Context context) {
        ...
        this.mNotificationManager = (NotificationManager) this.mContext.getSystemService(ServiceManagerNative.NOTIFICATION);
    }
    ...
    public static class NotifyTask implements Task {
        ...
        @Override // android.support.p003v4.app.NotificationManagerCompat.Task
