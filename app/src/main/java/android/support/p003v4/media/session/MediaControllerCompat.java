...
import android.support.p003v4.app.ComponentActivity;
...
import android.support.p003v4.media.session.IMediaControllerCallback;
import android.support.p003v4.media.session.IMediaSession;
import android.support.p003v4.media.session.MediaControllerCompatApi21;
import android.support.p003v4.media.session.MediaControllerCompatApi23;
import android.support.p003v4.media.session.MediaControllerCompatApi24;
...
public final class MediaControllerCompat {
            ...
            switch (c) {
                ...
                case 1:
                    if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                        throw new IllegalArgumentException("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action " + str + Consts.f23430h);
                    }
                    return;
                default:
                    return;
    ...
    public MediaControllerCompat(Context context, @NonNull MediaSessionCompat mediaSessionCompat) {
        if (mediaSessionCompat != null) {
            ...
            MediaControllerImplApi24 mediaControllerImplApi24 = null;
            try {
                if (Build.VERSION.SDK_INT >= 24) {
                    ...
                    mediaControllerImplApi24 = new MediaControllerImplBase(this.mToken);
                }
            } catch (RemoteException e) {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private static class StubApi21 implements MediaControllerCompatApi21.Callback {
            ...
            @Override // android.support.p003v4.media.session.MediaControllerCompatApi21.Callback
            public void onSessionDestroyed() {
        ...
        private static class StubCompat extends IMediaControllerCallback.Stub {
            ...
            @Override // android.support.p003v4.media.session.IMediaControllerCallback
    ...
    static class MediaControllerImplBase implements MediaControllerImpl {
        ...
        @Override // android.support.p003v4.media.session.MediaControllerCompat.MediaControllerImpl
        public Object getMediaController() {
            return null;
        }
    ...
    static class TransportControlsBase extends TransportControls {
        ...
        @Override // android.support.p003v4.media.session.MediaControllerCompat.TransportControls
        public void prepare() {
            try {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public static class ExtraCallback extends Callback.StubCompat {
            ...
            @Override // android.support.p003v4.media.session.MediaControllerCompat.Callback.StubCompat, android.support.p003v4.media.session.IMediaControllerCallback
            public void onSessionDestroyed() throws RemoteException {
    ...
    static class MediaControllerImplApi23 extends MediaControllerImplApi21 {
        ...
        @Override // android.support.p003v4.media.session.MediaControllerCompat.MediaControllerImplApi21, android.support.p003v4.media.session.MediaControllerCompat.MediaControllerImpl
        public TransportControls getTransportControls() {
            Object transportControls = MediaControllerCompatApi21.getTransportControls(this.mControllerObj);
            if (transportControls != null) {
    ...
    static class TransportControlsApi23 extends TransportControlsApi21 {
        ...
        @Override // android.support.p003v4.media.session.MediaControllerCompat.TransportControlsApi21, android.support.p003v4.media.session.MediaControllerCompat.TransportControls
        public void playFromUri(Uri uri, Bundle bundle) {
    ...
    static class MediaControllerImplApi24 extends MediaControllerImplApi23 {
        ...
        @Override // android.support.p003v4.media.session.MediaControllerCompat.MediaControllerImplApi23, android.support.p003v4.media.session.MediaControllerCompat.MediaControllerImplApi21, android.support.p003v4.media.session.MediaControllerCompat.MediaControllerImpl
        public TransportControls getTransportControls() {
            Object transportControls = MediaControllerCompatApi21.getTransportControls(this.mControllerObj);
            if (transportControls != null) {
