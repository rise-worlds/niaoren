...
import android.support.p003v4.media.session.PlaybackStateCompatApi21;
...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public String toString() {
        return "PlaybackState {state=" + this.mState + ", position=" + this.mPosition + ", buffered position=" + this.mBufferedPosition + ", speed=" + this.mSpeed + ", updated=" + this.mUpdateTime + ", actions=" + this.mActions + ", error code=" + this.mErrorCode + ", error message=" + this.mErrorMessage + ", custom actions=" + this.mCustomActions + ", active item id=" + this.mActiveItemId + C4963cj.f20747d;
    }
