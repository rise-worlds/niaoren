package android.support.p003v4.util;
    ...
    */
    public void trimToSize(int r5) {
        ...
        L_0x0071:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v4.util.LruCache.trimToSize(int):void");
    }
    ...
    private int safeSizeOf(K k, V v) {
        ...
        throw new IllegalStateException("Negative size: " + k + SimpleComparison.f23609c + v);
    }
