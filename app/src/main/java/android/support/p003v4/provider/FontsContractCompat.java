package android.support.p003v4.provider;
...
import android.support.p003v4.content.res.FontResourcesParserCompat;
import android.support.p003v4.content.res.ResourcesCompat;
import android.support.p003v4.graphics.TypefaceCompat;
import android.support.p003v4.graphics.TypefaceCompatUtil;
import android.support.p003v4.provider.SelfDestructiveThread;
...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, m25695to = 1000) int i2, boolean z, int i3) {
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        Uri uri;
        ArrayList arrayList = new ArrayList();
        Uri build = new Uri.Builder().scheme(ServiceManagerNative.CONTENT).authority(str).build();
        Uri build2 = new Uri.Builder().scheme(ServiceManagerNative.CONTENT).authority(str).appendPath("file").build();
        Cursor cursor = null;
        try {
