    ...
    */
    private static android.graphics.Typeface loadFont(@android.support.annotation.NonNull android.content.Context r14, android.content.res.Resources r15, android.util.TypedValue r16, int r17, int r18, @android.support.annotation.Nullable android.support.p003v4.content.res.ResourcesCompat.FontCallback r19, @android.support.annotation.Nullable android.os.Handler r20, boolean r21) {
        ...
        L_0x0024:
            return r12
        L_0x0025:
            android.graphics.Typeface r1 = android.support.p003v4.graphics.TypefaceCompat.findFromCache(r15, r4, r5)
        ...
        L_0x0030:
            return r1
        L_0x0031:
            java.lang.String r1 = r11.toLowerCase()     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008e
            java.lang.String r2 = ".xml"
            boolean r1 = r1.endsWith(r2)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008e
            if (r1 == 0) goto L_0x0065
            android.content.res.XmlResourceParser r1 = r15.getXml(r4)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008e
            android.support.v4.content.res.FontResourcesParserCompat$FamilyResourceEntry r2 = android.support.p003v4.content.res.FontResourcesParserCompat.parse(r1, r15)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008e
            if (r2 != 0) goto L_0x0054
            java.lang.String r0 = "ResourcesCompat"
            java.lang.String r1 = "Failed to find font-family tag"
            android.util.Log.e(r0, r1)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008e
            if (r9 == 0) goto L_0x0053
            r9.callbackFailAsync(r13, r10)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008e
        L_0x0053:
            return r12
        L_0x0054:
            r1 = r14
            ...
            r7 = r20
            r8 = r21
            android.graphics.Typeface r0 = android.support.p003v4.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008e
            return r0
        L_0x0065:
            r1 = r14
            android.graphics.Typeface r0 = android.support.p003v4.graphics.TypefaceCompat.createFromResourcesFontFile(r14, r15, r4, r11, r5)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008e
            if (r9 == 0) goto L_0x0075
            if (r0 == 0) goto L_0x0072
            r9.callbackSuccessAsync(r0, r10)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008e
            goto L_0x0075
        L_0x0072:
            r9.callbackFailAsync(r13, r10)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008e
        L_0x0075:
        ...
        L_0x00ab:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v4.content.res.ResourcesCompat.loadFont(android.content.Context, android.content.res.Resources, android.util.TypedValue, int, int, android.support.v4.content.res.ResourcesCompat$FontCallback, android.os.Handler, boolean):android.graphics.Typeface");
    }
