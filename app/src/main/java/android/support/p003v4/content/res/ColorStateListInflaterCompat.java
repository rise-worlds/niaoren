...
public final class ColorStateListInflaterCompat {
    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == i || ((depth = xmlPullParser.getDepth()) < depth2 && next == 3)) {
                ...
                TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet, C0078R.styleable.ColorStateListItem);
                int color = obtainAttributes.getColor(C0078R.styleable.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (obtainAttributes.hasValue(C0078R.styleable.ColorStateListItem_android_alpha)) {
                    f = obtainAttributes.getFloat(C0078R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(C0078R.styleable.ColorStateListItem_alpha)) {
                    f = obtainAttributes.getFloat(C0078R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (!(attributeNameResource == 16843173 || attributeNameResource == 16843551 || attributeNameResource == C0078R.attr.alpha)) {
                        i3++;
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i, @FloatRange(from = 0.0d, m25696to = 1.0d) float f) {
