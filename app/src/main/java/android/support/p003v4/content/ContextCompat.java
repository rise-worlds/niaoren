    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT > 17) {
                ...
                SERVICES.put(UserManager.class, ServiceManagerNative.USER);
            }
            if (Build.VERSION.SDK_INT > 16) {
            ...
            SERVICES.put(ActivityManager.class, ServiceManagerNative.ACTIVITY);
            ...
            SERVICES.put(NotificationManager.class, ServiceManagerNative.NOTIFICATION);
            ...
            SERVICES.put(TelephonyManager.class, ShippingInfoWidget.f12563f);
