...
public class ViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        void onPageScrolled(int i, float f, @AbstractC0074Px int i2);
    ...
    */
    void populate(int r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v4.view.ViewPager.populate(int):void");
    }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.position + C4963cj.f20747d;
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (true) {
            boolean z = true;
            int i6 = MemoryConstants.f21646d;
            if (i5 >= childCount) {
                break;
            }
            ...
            if (!(childAt.getVisibility() == 8 || (layoutParams2 = (LayoutParams) childAt.getLayoutParams()) == null || !layoutParams2.isDecor)) {
                ...
                if (z2) {
                    i9 = MemoryConstants.f21646d;
                    i6 = Integer.MIN_VALUE;
                } else {
                    i6 = z ? MemoryConstants.f21646d : Integer.MIN_VALUE;
                }
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingLeft, MemoryConstants.f21646d);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(measuredHeight, MemoryConstants.f21646d);
        this.mInLayout = true;
        populate();
        ...
        for (int i10 = 0; i10 < childCount2; i10++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * layoutParams.widthFactor), MemoryConstants.f21646d), this.mChildHeightMeasureSpec);
            }
        }
    }
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (infoForChild = infoForChild(childAt2)) != null) {
                    ...
                    if (layoutParams2.needsMeasure) {
                        ...
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), MemoryConstants.f21646d), View.MeasureSpec.makeMeasureSpec((i8 - i11) - i9, MemoryConstants.f21646d));
                    }
