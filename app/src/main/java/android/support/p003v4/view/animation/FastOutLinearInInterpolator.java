package android.support.p003v4.view.animation;
...
public class FastOutLinearInInterpolator extends LookupTableInterpolator {
    ...
    @Override // android.support.p003v4.view.animation.LookupTableInterpolator, android.animation.TimeInterpolator
