...
public class PathParser {
    ...
    */
    private static void extract(java.lang.String r8, int r9, android.support.p003v4.graphics.PathParser.ExtractFloatResult r10) {
        /*
            r0 = 0
        ...
        L_0x0041:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v4.graphics.PathParser.extract(java.lang.String, int, android.support.v4.graphics.PathParser$ExtractFloatResult):void");
    }
            ...
            while (i3 < fArr2.length) {
                ...
                switch (c2) {
                    case 'A':
                        ...
                        int i4 = i2 + 5;
                        int i5 = i2 + 6;
                        drawArc(path, f6, f7, fArr2[i4], fArr2[i5], fArr2[i2 + 0], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
                        f6 = fArr2[i4];
                        f7 = fArr2[i5];
                        f9 = f7;
                        f8 = f6;
                    ...
                    case 'a':
                        ...
                        int i27 = i3 + 6;
                        i2 = i3;
                        drawArc(path, f6, f7, fArr2[i26] + f6, fArr2[i27] + f7, fArr2[i3 + 0], fArr2[i3 + 1], fArr2[i3 + 2], fArr2[i3 + 3] != 0.0f, fArr2[i3 + 4] != 0.0f);
                        f6 += fArr2[i26];
                        f7 += fArr2[i27];
                        f9 = f7;
                        f8 = f6;
