...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        Builder parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                if (i3 < delimiterOffset) {
                    ...
                    if (this.port == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str.substring(i3, delimiterOffset) + Typography.f21049a);
                    }
                } else {
                    this.host = canonicalizeHost(str, i2, portColonOffset);
                ...
                if (this.host != null) {
                    ...
                    throw new IllegalArgumentException("Invalid URL host: \"" + str.substring(i2, portColonOffset) + Typography.f21049a);
                }
            } else {
        ...
        private boolean isDot(String str) {
            return str.equals(Consts.f23430h) || str.equalsIgnoreCase("%2e");
        }
