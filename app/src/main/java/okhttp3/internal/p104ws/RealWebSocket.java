package okhttp3.internal.p104ws;
...
import okhttp3.internal.p104ws.WebSocketReader;
...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.key = ByteString.m14867of(bArr).base64();
    ...
    void checkResponse(Response response) throws ProtocolException {
        ...
        throw new ProtocolException("Expected HTTP 101 response but was '" + response.code() + ExpandableTextView.f6958c + response.message() + "'");
    }
    ...
    @Override // okhttp3.internal.p104ws.WebSocketReader.FrameCallback
