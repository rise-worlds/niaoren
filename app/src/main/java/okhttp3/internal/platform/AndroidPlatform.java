...
public class AndroidPlatform extends Platform {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:7:0x000b, code lost:
        if (android.os.Build.VERSION.SDK_INT < 22) goto L_0x000f;
     */
    @Override // okhttp3.internal.platform.Platform
    /*
    ...
    */
    public javax.net.ssl.SSLContext getSSLContext() {
        /*
            r3 = this;
            r0 = 1
            int r1 = android.os.Build.VERSION.SDK_INT     // Catch: NoClassDefFoundError -> 0x000f
            r2 = 16
        ...
        L_0x000f:
            ...
            javax.net.ssl.SSLContext r0 = javax.net.ssl.SSLContext.getInstance(r0)     // Catch: NoSuchAlgorithmException -> 0x0018
            return r0
        L_0x0018:
            java.lang.String r0 = "TLS"
            javax.net.ssl.SSLContext r0 = javax.net.ssl.SSLContext.getInstance(r0)     // Catch: NoSuchAlgorithmException -> 0x001f
            return r0
        L_0x001f:
            r0 = move-exception
