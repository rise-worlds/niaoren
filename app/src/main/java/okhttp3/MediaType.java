                ...
                if (matcher2.lookingAt()) {
                    ...
                    if (group != null && group.equalsIgnoreCase(HttpRequest.PARAM_CHARSET)) {
                        ...
                        if (str2 == null || group2.equalsIgnoreCase(str2)) {
                            ...
                            throw new IllegalArgumentException("Multiple charsets defined: \"" + str2 + "\" and: \"" + group2 + "\" for: \"" + str + Typography.f21049a);
                        }
                    }
                } else {
                    throw new IllegalArgumentException("Parameter is not formatted correctly: \"" + str.substring(end) + "\" for: \"" + str + Typography.f21049a);
                }
            }
            return new MediaType(str, lowerCase, lowerCase2, str2);
        }
        throw new IllegalArgumentException("No subtype found for: \"" + str + Typography.f21049a);
    }
