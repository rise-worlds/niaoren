...
public class SetValue extends BaseComparison {
    ...
    /* renamed from: c */
    private static final ArgumentHolder f23608c = new NullArgHolder();
    ...
    public SetValue(String str, FieldType ssVar, Object obj) throws SQLException {
        super(str, ssVar, obj == null ? f23608c : obj, false);
    }
