...
public final class ObservableFlatMapMaybe<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    /* renamed from: b */
    final Function<? super T, ? extends MaybeSource<? extends R>> f19117b;

    /* renamed from: c */
    final boolean f19118c;

    public ObservableFlatMapMaybe(ObservableSource<T> asqVar, Function<? super T, ? extends MaybeSource<? extends R>> aunVar, boolean z) {
        super(asqVar);
        this.f19117b = aunVar;
        this.f19118c = z;
    }
    ...
    protected void mo34a(Observer<? super R> assVar) {
        this.f18807a.subscribe(new C4450a(assVar, this.f19117b, this.f19118c));
    }

    /* compiled from: ObservableFlatMapMaybe.java */
    /* renamed from: z1.bke$a */
    /* loaded from: classes3.dex */
    static final class C4450a<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        C4450a(Observer<? super R> assVar, Function<? super T, ? extends MaybeSource<? extends R>> aunVar, boolean z) {
        ...
        void innerSuccess(C4450a<T, R>.C4451a aVar, R r) {
        ...
        void innerError(C4450a<T, R>.C4451a aVar, Throwable th) {
            this.set.mo9936c(aVar);
            if (this.errors.addThrowable(th)) {
                if (!this.delayErrors) {
                    this.upstream.dispose();
        ...
        void innerComplete(C4450a<T, R>.C4451a aVar) {
            this.set.mo9936c(aVar);
            if (get() == 0) {
                boolean z = true;
                if (compareAndSet(0, 1)) {
        ...
        /* compiled from: ObservableFlatMapMaybe.java */
        /* renamed from: z1.bke$a$a */
        /* loaded from: classes3.dex */
        final class C4451a extends AtomicReference<Disposable> implements MaybeObserver<R>, Disposable {
            ...
            public void onSuccess(R r) {
                C4450a.this.innerSuccess(this, r);
            }

            @Override // p110z1.MaybeObserver, p110z1.SingleObserver
            public void onError(Throwable th) {
                C4450a.this.innerError(this, th);
            }

            @Override // p110z1.MaybeObserver
            public void onComplete() {
                C4450a.this.innerComplete(this);
            }
