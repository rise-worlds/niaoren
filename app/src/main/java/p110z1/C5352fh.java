...
public class C5352fh {

    /* renamed from: a */
    public static final int f21630a = 32;

    /* renamed from: b */
    public static final int f21631b = 8;

    /* renamed from: a */
    public static int m2863a(Context context) {
        DisplayMetrics e = m2854e(context);
        return m2853f(context) ? e.heightPixels : e.widthPixels;
    }

    /* renamed from: b */
    public static int m2858b(Context context) {
        return m2854e(context).widthPixels;
    }

    /* renamed from: c */
    public static int m2856c(Context context) {
        DisplayMetrics e = m2854e(context);
        return m2853f(context) ? e.widthPixels : e.heightPixels;
    }

    /* renamed from: d */
    public static int m2855d(Context context) {
        return m2854e(context).heightPixels;
    }

    /* renamed from: e */
    public static DisplayMetrics m2854e(Context context) {
        return context.getResources().getDisplayMetrics();
    }

    /* renamed from: f */
    public static boolean m2853f(Context context) {
        return context.getResources().getConfiguration().orientation == 2;
    }

    /* renamed from: a */
    public static int m2862a(Context context, float f) {
        return (int) ((f * context.getResources().getDisplayMetrics().density) + 0.5f);
    }

    /* renamed from: b */
    public static int m2857b(Context context, float f) {
        return (int) ((f / context.getResources().getDisplayMetrics().density) + 0.5f);
    }

    /* renamed from: g */
    public static float m2852g(Context context) {
        return context.getResources().getDisplayMetrics().density;
    }

    /* renamed from: h */
    public static int[] m2851h(Context context) {
        int[] iArr = new int[2];
        if (iArr[0] != 0) {
            return iArr;
        }
    ...
    /* renamed from: i */
    public static String m2850i(Context context) {
        DisplayMetrics displayMetrics = new DisplayMetrics();
        ((WindowManager) context.getApplicationContext().getSystemService("window")).getDefaultDisplay().getMetrics(displayMetrics);
    ...
    /* renamed from: j */
    public static int m2849j(Context context) {
        try {
    ...
    @TargetApi(17)
    /* renamed from: k */
    public static int m2848k(Context context) {
    ...
    /* renamed from: a */
    public static boolean m2864a(Activity activity) {
        return m2860a("ro.miui.notch", activity) == 1 || m2845n(activity) || m2843p(activity) || m2844o(activity) || m2859b(activity) != null;
    }

    /* renamed from: b */
    private static DisplayCutout m2859b(Activity activity) {
    ...
    /* renamed from: a */
    private static int m2860a(String str, Activity activity) {
    ...
    /* renamed from: n */
    private static boolean m2845n(Context context) {
        try {
            try {
                try {
    ...
    /* renamed from: o */
    private static boolean m2844o(Context context) {
        try {
            try {
                try {
    ...
    /* renamed from: p */
    private static boolean m2843p(Context context) {
        return context.getPackageManager().hasSystemFeature("com.oppo.feature.screen.heteromorphism");
    }

    /* renamed from: l */
    public static boolean m2847l(Context context) {
        try {
    ...
    */
    public static boolean m2846m(@android.support.annotation.NonNull android.content.Context r7) {
        /*
        ...
        L_0x00aa:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p110z1.C5352fh.m2846m(android.content.Context):boolean");
    }

    @TargetApi(17)
    /* renamed from: a */
    public static boolean m2861a(@NonNull Context context, @NonNull Window window) {
