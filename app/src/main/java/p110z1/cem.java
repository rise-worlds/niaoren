...
public abstract class cem extends cel implements cep, FunctionBase<Object> {
    ...
    public cem(int i, @dbs Continuation<Object> ccpVar) {
        super(ccpVar);
        this.arity = i;
    }
    ...
    public String toString() {
        ...
        String a = Reflection.m5119a(this);
        cji.m5175b(a, "Reflection.renderLambdaToString(this)");
        return a;
    }
}
