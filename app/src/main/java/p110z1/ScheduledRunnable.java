...
public final class ScheduledRunnable extends AtomicReferenceArray<Object> implements Runnable, Callable<Object>, Disposable {
    ...
    public ScheduledRunnable(Runnable runnable, DisposableContainer avaVar) {
        super(3);
    ...
    public void run() {
        ...
        try {
            ...
            try {
                ...
                if (!(obj3 == PARENT_DISPOSED || !compareAndSet(0, obj3, DONE) || obj3 == null)) {
                    ((DisposableContainer) obj3).mo9936c(this);
                }
                do {
                    obj2 = get(1);
        ...
        if (!(obj4 == PARENT_DISPOSED || !compareAndSet(0, obj4, DONE) || obj4 == null)) {
            ((DisposableContainer) obj4).mo9936c(this);
        }
        do {
            obj = get(1);
    ...
    public void dispose() {
        ...
        ((DisposableContainer) obj).mo9936c(this);
    }
