...
public final class Tuples<A, B> implements Serializable {
    ...
    public static /* synthetic */ Tuples copy$default(Tuples bwoVar, Object obj, Object obj2, int i, Object obj3) {
        if ((i & 1) != 0) {
            obj = bwoVar.first;
        }
        if ((i & 2) != 0) {
    ...
    public boolean equals(@dbs Object obj) {
        ...
        Tuples bwoVar = (Tuples) obj;
        return cji.m5184a(this.first, bwoVar.first) && cji.m5184a(this.second, bwoVar.second);
    }
