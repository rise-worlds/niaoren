...
public abstract class ParameterHandler<T> {
    ...
    static final class RelativeUrl extends ParameterHandler<Object> {
        ...
        void apply(RequestBuilder requestBuilder, @Nullable Object obj) {
            ...
            throw Utils.parameterError(this.method, this.f15030p, "@Url parameter is null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f15029p, "Query map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f15029p, "Query map was null", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f15024p, "Header map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f15024p, "Header map was null.", new Object[0]);
        }
    }
    ...
    static final class Headers extends ParameterHandler<okhttp3.Headers> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable okhttp3.Headers headers) {
            ...
            throw Utils.parameterError(this.method, this.f15025p, "Headers parameter must not be null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f15023p, "Field map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f15023p, "Field map was null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        T value = entry.getValue();
                        if (value != null) {
                            requestBuilder.addPart(okhttp3.Headers.m14869of(MIME.CONTENT_DISPOSITION, "form-data; name=\"" + key + "\"", MIME.CONTENT_TRANSFER_ENC, this.transferEncoding), this.valueConverter.convert(value));
                        } else {
                            Method method = this.method;
                            int i = this.f15027p;
                        ...
                        throw Utils.parameterError(this.method, this.f15027p, "Part map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f15027p, "Part map was null.", new Object[0]);
        }
    }
    ...
    static final class Body<T> extends ParameterHandler<T> {
        ...
        void apply(RequestBuilder requestBuilder, @Nullable T t) {
            if (t != null) {
                ...
                throw Utils.parameterError(this.method, this.f15022p, "Body parameter value must not be null.", new Object[0]);
            }
        }
    }
