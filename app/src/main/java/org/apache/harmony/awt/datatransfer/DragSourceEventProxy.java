...
public class DragSourceEventProxy implements Runnable {
    ...
    /* renamed from: x */
    private final int f14722x;

    /* renamed from: y */
    private final int f14723y;
    ...
    public DragSourceEventProxy(DragSourceContext dragSourceContext, int i, int i2, int i3, Point point, int i4) {
        ...
        this.f14722x = point.x;
        this.f14723y = point.y;
        this.modifiers = i4;
        this.success = false;
    }
    ...
    public void run() {
        switch (this.type) {
            ...
            case 4:
                ...
                return;
            case 5:
                DragSourceContext dragSourceContext = this.context;
                dragSourceContext.dragExit(new DragSourceEvent(dragSourceContext, this.f14722x, this.f14723y));
                return;
            case 6:
                DragSourceContext dragSourceContext2 = this.context;
                dragSourceContext2.dragExit(new DragSourceDropEvent(dragSourceContext2, this.userAction, this.success, this.f14722x, this.f14723y));
                return;
            default:
                return;
        }
    ...
    private DragSourceDragEvent newDragSourceDragEvent() {
        return new DragSourceDragEvent(this.context, this.userAction, this.targetActions, this.modifiers, this.f14722x, this.f14723y);
    }
}
