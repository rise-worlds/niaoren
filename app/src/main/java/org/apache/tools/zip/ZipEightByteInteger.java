...
public final class ZipEightByteInteger {
    ...
    public static byte[] getBytes(BigInteger bigInteger) {
        ...
        bArr[3] = (byte) ((BYTE_3_MASK & longValue) >> 24);
        bArr[4] = (byte) ((BYTE_4_MASK & longValue) >> 32);
        bArr[5] = (byte) ((BYTE_5_MASK & longValue) >> 40);
        bArr[6] = (byte) ((BYTE_6_MASK & longValue) >> 48);
        bArr[7] = (byte) ((longValue & BYTE_7_MASK) >> 56);
