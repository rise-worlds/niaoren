...
import org.apache.commons.p105io.output.ByteArrayOutputStream;
import org.apache.commons.p105io.output.StringBuilderWriter;
    ...
    */
    public static boolean contentEqualsIgnoreEOL(java.io.Reader r4, java.io.Reader r5) throws java.io.IOException {
        ...
        L_0x002e:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.p105io.IOUtils.contentEqualsIgnoreEOL(java.io.Reader, java.io.Reader):boolean");
    }
    ...
    public static long skip(ReadableByteChannel readableByteChannel, long j) throws IOException {
        if (j >= 0) {
            ByteBuffer allocate = ByteBuffer.allocate((int) Math.min(j, (long) PlaybackStateCompat.ACTION_PLAY_FROM_SEARCH));
            long j2 = j;
            while (j2 > 0) {
                allocate.position(0);
                allocate.limit((int) Math.min(j2, (long) PlaybackStateCompat.ACTION_PLAY_FROM_SEARCH));
