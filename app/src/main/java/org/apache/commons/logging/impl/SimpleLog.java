...
public class SimpleLog implements Log, Serializable {
    ...
    public SimpleLog(String name) {
        ...
        int i = String.valueOf(name).lastIndexOf(Consts.f23430h);
        while (lvl == null && i > -1) {
            name = name.substring(0, i);
            lvl = getStringProperty("org.apache.commons.logging.simplelog.log." + name);
            i = String.valueOf(name).lastIndexOf(Consts.f23430h);
        }
        ...
        if ("all".equalsIgnoreCase(lvl)) {
            ...
            setLevel(4);
        } else if (PaymentResultListener.f11903c.equalsIgnoreCase(lvl)) {
            setLevel(5);
    ...
    protected void log(int type, Object message, Throwable t) {
        ...
        if (showDateTime) {
            ...
            buf.append(ExpandableTextView.f6958c);
        }
        switch (type) {
            case 1:
                buf.append("[TRACE] ");
        ...
        if (showShortName) {
            if (this.shortLogName == null) {
                this.shortLogName = this.logName.substring(this.logName.lastIndexOf(Consts.f23430h) + 1);
        ...
        if (t != null) {
            ...
            buf.append(SimpleComparison.f23610d);
