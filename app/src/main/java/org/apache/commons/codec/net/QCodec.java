...
public class QCodec extends RFC1522Codec implements StringEncoder, StringDecoder {
    ...
    static {
        ...
        PRINTABLE_CHARS.set(TbsListener.ErrorCode.DOWNLOAD_RETRYTIMES302_EXCEED);
        PRINTABLE_CHARS.set(TbsListener.ErrorCode.DOWNLOAD_REDIRECT_EMPTY);
        PRINTABLE_CHARS.set(TbsListener.ErrorCode.DOWNLOAD_THROWABLE);
        PRINTABLE_CHARS.set(TbsListener.ErrorCode.PV_UPLOAD_ERROR);
        BLANK = (byte) 32;
        UNDERSCORE = (byte) 95;
    }
