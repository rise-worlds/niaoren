...
public class Base64 implements BinaryEncoder, BinaryDecoder {
    ...
    public static byte[] encodeBase64(byte[] binaryData, boolean isChunked) {
        ...
        while (i < numberTriplets3) {
            ...
            byte l = (byte) (b2 & 15);
            byte k = (byte) (b1 & 3);
            byte val1 = (byte) ((b1 & cin.f20709a) == 0 ? b1 >> 2 : (b1 >> 2) ^ 192);
            if ((b2 & cin.f20709a) == 0) {
                lengthDataBits = lengthDataBits3;
                lengthDataBits2 = b2 >> 4;
            } else {
                lengthDataBits = lengthDataBits3;
                lengthDataBits2 = (b2 >> 4) ^ TbsListener.ErrorCode.TPATCH_VERSION_FAILED;
            }
        ...
        if (fewerThan24bits == 8) {
            ...
            byte k2 = (byte) (b12 & 3);
            byte val12 = (byte) ((b12 & cin.f20709a) == 0 ? b12 >> 2 : (b12 >> 2) ^ 192);
            ...
            byte l2 = (byte) (b22 & 15);
            byte k3 = (byte) (b13 & 3);
            byte val13 = (byte) ((b13 & cin.f20709a) == 0 ? b13 >> 2 : (b13 >> 2) ^ 192);
            byte val22 = (byte) ((b22 & cin.f20709a) == 0 ? b22 >> 4 : (b22 >> 4) ^ TbsListener.ErrorCode.TPATCH_VERSION_FAILED);
