...
public class RFC2965DomainAttributeHandler implements CookieAttributeHandler {
    ...
    public void parse(SetCookie cookie, String domain) throws MalformedCookieException {
        if (cookie == null) {
            ...
            if (!domain2.startsWith(Consts.f23430h)) {
                domain2 = FilenameUtils.EXTENSION_SEPARATOR + domain2;
            }
    ...
    public boolean domainMatch(String host, String domain) {
        return host.equals(domain) || (domain.startsWith(Consts.f23430h) && host.endsWith(domain));
    }
    ...
    public void validate(Cookie cookie, CookieOrigin origin) throws MalformedCookieException {
        if (cookie == null) {
            ...
            if (cookie.getDomain() != null) {
                ...
                } else if (cookieDomain.startsWith(Consts.f23430h)) {
