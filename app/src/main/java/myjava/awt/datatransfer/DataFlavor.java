...
public class DataFlavor implements Externalizable, Cloneable {
    ...
    public boolean equals(DataFlavor dataFlavor) {
        ...
        if (!this.mimeInfo.getPrimaryType().equals(ContainsSelector.CONTAINS_KEY) || isUnicodeFlavor()) {
            return true;
        }
    ...
    public boolean isFlavorTextType() {
        ...
        MimeTypeProcessor.MimeType mimeType = this.mimeInfo;
        if (mimeType != null && !mimeType.getPrimaryType().equals(ContainsSelector.CONTAINS_KEY)) {
            return false;
        }
        String charset = getCharset();
        if (!isByteCodeFlavor()) {
