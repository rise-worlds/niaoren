...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f6934CR = 13;

    /* renamed from: LF */
    private static final byte f6935LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f6936in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f6936in;
        byte[] bArr = this.buf;
