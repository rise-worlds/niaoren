    ...
    */
    public boolean encode(@android.support.annotation.NonNull com.bumptech.glide.load.engine.Resource<android.graphics.Bitmap> r8, @android.support.annotation.NonNull java.io.File r9, @android.support.annotation.NonNull com.bumptech.glide.load.Options r10) {
        /*
            ...
            r4 = 0
            r5 = 0
            java.io.FileOutputStream r6 = new java.io.FileOutputStream     // Catch: all -> 0x0055, IOException -> 0x0057
            r6.<init>(r9)     // Catch: all -> 0x0055, IOException -> 0x0057
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r9 = r7.arrayPool     // Catch: all -> 0x004f, IOException -> 0x0052
            if (r9 == 0) goto L_0x0043
            com.bumptech.glide.load.data.BufferedOutputStream r9 = new com.bumptech.glide.load.data.BufferedOutputStream     // Catch: all -> 0x004f, IOException -> 0x0052
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r5 = r7.arrayPool     // Catch: all -> 0x004f, IOException -> 0x0052
            r9.<init>(r6, r5)     // Catch: all -> 0x004f, IOException -> 0x0052
            r5 = r9
            goto L_0x0044
        L_0x0043:
            r5 = r6
        L_0x0044:
            r8.compress(r0, r3, r5)     // Catch: all -> 0x0055, IOException -> 0x0057
            r5.close()     // Catch: all -> 0x0055, IOException -> 0x0057
            r4 = 1
        L_0x004b:
