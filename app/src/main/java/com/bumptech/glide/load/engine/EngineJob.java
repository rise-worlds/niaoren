...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
        ...
        synchronized (this) {
            ...
            if (this.isCancelled) {
                ...
                while (it.hasNext()) {
                    ...
                    next.executor.execute(new CallResourceReady(next.f6946cb));
                }
    ...
    void notifyCallbacksOfException() {
        synchronized (this) {
            ...
            if (this.isCancelled) {
                ...
                while (it.hasNext()) {
                    ResourceCallbackAndExecutor next = it.next();
                    next.executor.execute(new CallLoadFailed(next.f6946cb));
                }
                decrementPendingCallbacks();
            } else {
    ...
    public class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f6944cb;

        CallLoadFailed(ResourceCallback resourceCallback) {
            this.f6944cb = resourceCallback;
        }

        @Override // java.lang.Runnable
        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f6944cb)) {
                    EngineJob.this.callCallbackOnLoadFailed(this.f6944cb);
                }
    ...
    public class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f6945cb;

        CallResourceReady(ResourceCallback resourceCallback) {
            this.f6945cb = resourceCallback;
        }

        @Override // java.lang.Runnable
        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f6945cb)) {
                    EngineJob.this.engineResource.acquire();
                    EngineJob.this.callCallbackOnResourceReady(this.f6945cb);
                    EngineJob.this.removeCallback(this.f6945cb);
                }
                EngineJob.this.decrementPendingCallbacks();
            }
        }
    ...
    public static final class ResourceCallbackAndExecutor {
        ...
        /* renamed from: cb */
        final ResourceCallback f6946cb;
        final Executor executor;

        ResourceCallbackAndExecutor(ResourceCallback resourceCallback, Executor executor) {
            this.f6946cb = resourceCallback;
            this.executor = executor;
        }

        public boolean equals(Object obj) {
            if (obj instanceof ResourceCallbackAndExecutor) {
                return this.f6946cb.equals(((ResourceCallbackAndExecutor) obj).f6946cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f6946cb.hashCode();
        }
    }
