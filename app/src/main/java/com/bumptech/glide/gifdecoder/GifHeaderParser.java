...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f6939ix = readShort();
        this.header.currentFrame.f6940iy = readShort();
        this.header.currentFrame.f6938iw = readShort();
        this.header.currentFrame.f6937ih = readShort();
        int read = read();
        boolean z = false;
    ...
    private int[] readColorTable(int i) {
        ...
        try {
            ...
            while (i2 < i) {
                ...
                i3 = i6 + 1;
                i2++;
                iArr[i2] = (i5 << 16) | (-16777216) | ((bArr[i4] & 255) << 8) | (bArr[i6] & 255);
            }
