...
/* renamed from: com.stripe.android.i */
/* loaded from: classes2.dex */
public class PayWithGoogleUtils {
    @NonNull
    /* renamed from: a */
    public static String m17998a(@NonNull long j, @NonNull Currency currency) {
        ...
        return decimalFormat2.format(d / Math.pow(10.0d, defaultFractionDigits));
    }
}
