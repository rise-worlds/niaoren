...
/* renamed from: com.lbd.xj.zygote_service.MyService17 */
/* loaded from: classes.dex */
public class MyService17 extends Service {

    /* renamed from: a */
    static final boolean f10032a = false;

    /* renamed from: b */
    String f10033b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10035d = true;

    /* renamed from: c */
    MyReceiver f10034c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService17$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10036a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService17.this.f10033b, "on Recv");
            MyService17.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10034c = new MyReceiver();
        registerReceiver(this.f10034c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10034c;
        if (myReceiver != null) {
