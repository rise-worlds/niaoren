...
/* renamed from: com.lbd.xj.zygote_service.MyService27 */
/* loaded from: classes.dex */
public class MyService27 extends Service {

    /* renamed from: a */
    static final boolean f10098a = false;

    /* renamed from: b */
    String f10099b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10101d = true;

    /* renamed from: c */
    MyReceiver f10100c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService27$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10102a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService27.this.f10099b, "on Recv");
            MyService27.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10100c = new MyReceiver();
        registerReceiver(this.f10100c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10100c;
        if (myReceiver != null) {
