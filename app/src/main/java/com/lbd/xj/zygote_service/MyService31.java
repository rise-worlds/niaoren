...
/* renamed from: com.lbd.xj.zygote_service.MyService31 */
/* loaded from: classes.dex */
public class MyService31 extends Service {

    /* renamed from: a */
    static final boolean f10128a = false;

    /* renamed from: b */
    String f10129b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10131d = true;

    /* renamed from: c */
    MyReceiver f10130c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService31$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10132a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService31.this.f10129b, "on Recv");
            MyService31.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10130c = new MyReceiver();
        registerReceiver(this.f10130c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10130c;
        if (myReceiver != null) {
