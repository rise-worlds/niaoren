...
/* renamed from: com.lbd.xj.zygote_service.MyService5 */
/* loaded from: classes.dex */
public class MyService5 extends Service {

    /* renamed from: a */
    static final boolean f10194a = false;

    /* renamed from: b */
    String f10195b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10197d = true;

    /* renamed from: c */
    MyReceiver f10196c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService5$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10198a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService5.this.f10195b, "on Recv");
            MyService5.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10196c = new MyReceiver();
        registerReceiver(this.f10196c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10196c;
        if (myReceiver != null) {
