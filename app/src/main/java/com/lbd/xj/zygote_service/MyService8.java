...
/* renamed from: com.lbd.xj.zygote_service.MyService8 */
/* loaded from: classes.dex */
public class MyService8 extends Service {

    /* renamed from: a */
    static final boolean f10212a = false;

    /* renamed from: b */
    String f10213b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10215d = true;

    /* renamed from: c */
    MyReceiver f10214c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService8$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10216a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService8.this.f10213b, "on Recv");
            MyService8.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10214c = new MyReceiver();
        registerReceiver(this.f10214c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10214c;
        if (myReceiver != null) {
