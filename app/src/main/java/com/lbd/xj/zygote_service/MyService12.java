...
/* renamed from: com.lbd.xj.zygote_service.MyService12 */
/* loaded from: classes.dex */
public class MyService12 extends Service {

    /* renamed from: a */
    static final boolean f10002a = false;

    /* renamed from: b */
    String f10003b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10005d = true;

    /* renamed from: c */
    MyReceiver f10004c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService12$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10006a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService12.this.f10003b, "on Recv");
    ...
    public void onCreate() {
        super.onCreate();
        this.f10004c = new MyReceiver();
        registerReceiver(this.f10004c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10004c;
        if (myReceiver != null) {
