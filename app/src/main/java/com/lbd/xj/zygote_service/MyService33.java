...
/* renamed from: com.lbd.xj.zygote_service.MyService33 */
/* loaded from: classes.dex */
public class MyService33 extends Service {

    /* renamed from: a */
    static final boolean f10140a = false;

    /* renamed from: b */
    String f10141b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10143d = true;

    /* renamed from: c */
    MyReceiver f10142c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService33$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10144a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService33.this.f10141b, "on Recv");
            MyService33.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10142c = new MyReceiver();
        registerReceiver(this.f10142c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10142c;
        if (myReceiver != null) {
