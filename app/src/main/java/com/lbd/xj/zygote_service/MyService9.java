...
/* renamed from: com.lbd.xj.zygote_service.MyService9 */
/* loaded from: classes.dex */
public class MyService9 extends Service {

    /* renamed from: a */
    static final boolean f10218a = false;

    /* renamed from: b */
    String f10219b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10221d = true;

    /* renamed from: c */
    MyReceiver f10220c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService9$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10222a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService9.this.f10219b, "on Recv");
            MyService9.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10220c = new MyReceiver();
        registerReceiver(this.f10220c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10220c;
        if (myReceiver != null) {
