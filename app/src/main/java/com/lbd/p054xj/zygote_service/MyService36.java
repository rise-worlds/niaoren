...
/* renamed from: com.lbd.xj.zygote_service.MyService36 */
/* loaded from: classes.dex */
public class MyService36 extends Service {

    /* renamed from: a */
    static final boolean f10158a = false;

    /* renamed from: b */
    String f10159b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10161d = true;

    /* renamed from: c */
    MyReceiver f10160c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService36$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10162a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService36.this.f10159b, "on Recv");
            MyService36.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10160c = new MyReceiver();
        registerReceiver(this.f10160c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10160c;
        if (myReceiver != null) {
