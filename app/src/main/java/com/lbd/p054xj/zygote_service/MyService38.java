...
/* renamed from: com.lbd.xj.zygote_service.MyService38 */
/* loaded from: classes.dex */
public class MyService38 extends Service {

    /* renamed from: a */
    static final boolean f10170a = false;

    /* renamed from: b */
    String f10171b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10173d = true;

    /* renamed from: c */
    MyReceiver f10172c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService38$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10174a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService38.this.f10171b, "on Recv");
            MyService38.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10172c = new MyReceiver();
        registerReceiver(this.f10172c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10172c;
        if (myReceiver != null) {
