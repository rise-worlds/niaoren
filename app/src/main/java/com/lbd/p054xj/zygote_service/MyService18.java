...
/* renamed from: com.lbd.xj.zygote_service.MyService18 */
/* loaded from: classes.dex */
public class MyService18 extends Service {

    /* renamed from: a */
    static final boolean f10038a = false;

    /* renamed from: b */
    String f10039b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10041d = true;

    /* renamed from: c */
    MyReceiver f10040c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService18$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10042a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService18.this.f10039b, "on Recv");
            MyService18.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10040c = new MyReceiver();
        registerReceiver(this.f10040c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10040c;
        if (myReceiver != null) {
