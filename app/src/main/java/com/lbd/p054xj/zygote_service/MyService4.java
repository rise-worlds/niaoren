...
/* renamed from: com.lbd.xj.zygote_service.MyService4 */
/* loaded from: classes.dex */
public class MyService4 extends Service {

    /* renamed from: a */
    static final boolean f10182a = false;

    /* renamed from: b */
    String f10183b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10185d = true;

    /* renamed from: c */
    MyReceiver f10184c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService4$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10186a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService4.this.f10183b, "on Recv");
            MyService4.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10184c = new MyReceiver();
        registerReceiver(this.f10184c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10184c;
        if (myReceiver != null) {
