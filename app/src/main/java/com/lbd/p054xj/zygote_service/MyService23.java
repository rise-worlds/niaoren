...
/* renamed from: com.lbd.xj.zygote_service.MyService23 */
/* loaded from: classes.dex */
public class MyService23 extends Service {

    /* renamed from: a */
    static final boolean f10074a = false;

    /* renamed from: b */
    String f10075b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10077d = true;

    /* renamed from: c */
    MyReceiver f10076c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService23$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10078a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService23.this.f10075b, "on Recv");
            MyService23.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10076c = new MyReceiver();
        registerReceiver(this.f10076c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10076c;
        if (myReceiver != null) {
