...
/* renamed from: com.lbd.xj.zygote_service.MyService22 */
/* loaded from: classes.dex */
public class MyService22 extends Service {

    /* renamed from: a */
    static final boolean f10068a = false;

    /* renamed from: b */
    String f10069b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10071d = true;

    /* renamed from: c */
    MyReceiver f10070c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService22$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10072a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService22.this.f10069b, "on Recv");
            MyService22.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10070c = new MyReceiver();
        registerReceiver(this.f10070c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10070c;
        if (myReceiver != null) {
