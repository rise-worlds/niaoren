...
/* renamed from: com.lbd.xj.zygote_service.MyService13 */
/* loaded from: classes.dex */
public class MyService13 extends Service {

    /* renamed from: a */
    static final boolean f10008a = false;

    /* renamed from: b */
    String f10009b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10011d = true;

    /* renamed from: c */
    MyReceiver f10010c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService13$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10012a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService13.this.f10009b, "on Recv");
            MyService13.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10010c = new MyReceiver();
        registerReceiver(this.f10010c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10010c;
        if (myReceiver != null) {
