...
/* renamed from: com.lbd.xj.zygote_service.MyService32 */
/* loaded from: classes.dex */
public class MyService32 extends Service {

    /* renamed from: a */
    static final boolean f10134a = false;

    /* renamed from: b */
    String f10135b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10137d = true;

    /* renamed from: c */
    MyReceiver f10136c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService32$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10138a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService32.this.f10135b, "on Recv");
            MyService32.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10136c = new MyReceiver();
        registerReceiver(this.f10136c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10136c;
        if (myReceiver != null) {
