...
/* renamed from: com.lbd.xj.zygote_service.MyService37 */
/* loaded from: classes.dex */
public class MyService37 extends Service {

    /* renamed from: a */
    static final boolean f10164a = false;

    /* renamed from: b */
    String f10165b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10167d = true;

    /* renamed from: c */
    MyReceiver f10166c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService37$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10168a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService37.this.f10165b, "on Recv");
            MyService37.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10166c = new MyReceiver();
        registerReceiver(this.f10166c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10166c;
        if (myReceiver != null) {
