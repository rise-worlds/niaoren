...
/* renamed from: com.lbd.xj.zygote_service.MyService29 */
/* loaded from: classes.dex */
public class MyService29 extends Service {

    /* renamed from: a */
    static final boolean f10110a = false;

    /* renamed from: b */
    String f10111b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10113d = true;

    /* renamed from: c */
    MyReceiver f10112c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService29$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10114a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService29.this.f10111b, "on Recv");
            MyService29.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10112c = new MyReceiver();
        registerReceiver(this.f10112c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10112c;
        if (myReceiver != null) {
