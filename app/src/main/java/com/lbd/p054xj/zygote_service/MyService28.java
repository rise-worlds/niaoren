...
/* renamed from: com.lbd.xj.zygote_service.MyService28 */
/* loaded from: classes.dex */
public class MyService28 extends Service {

    /* renamed from: a */
    static final boolean f10104a = false;

    /* renamed from: b */
    String f10105b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10107d = true;

    /* renamed from: c */
    MyReceiver f10106c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService28$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10108a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService28.this.f10105b, "on Recv");
            MyService28.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10106c = new MyReceiver();
        registerReceiver(this.f10106c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10106c;
        if (myReceiver != null) {
