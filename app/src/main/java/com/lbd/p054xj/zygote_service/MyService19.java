...
/* renamed from: com.lbd.xj.zygote_service.MyService19 */
/* loaded from: classes.dex */
public class MyService19 extends Service {

    /* renamed from: a */
    static final boolean f10044a = false;

    /* renamed from: b */
    String f10045b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10047d = true;

    /* renamed from: c */
    MyReceiver f10046c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService19$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10048a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService19.this.f10045b, "on Recv");
            MyService19.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10046c = new MyReceiver();
        registerReceiver(this.f10046c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10046c;
        if (myReceiver != null) {
