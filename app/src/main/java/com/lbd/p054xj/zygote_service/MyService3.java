...
/* renamed from: com.lbd.xj.zygote_service.MyService3 */
/* loaded from: classes.dex */
public class MyService3 extends Service {

    /* renamed from: a */
    static final boolean f10116a = false;

    /* renamed from: b */
    String f10117b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10119d = true;

    /* renamed from: c */
    MyReceiver f10118c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService3$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10120a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService3.this.f10117b, "on Recv");
            MyService3.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10118c = new MyReceiver();
        registerReceiver(this.f10118c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10118c;
        if (myReceiver != null) {
