...
/* renamed from: com.lbd.xj.zygote_service.MyService24 */
/* loaded from: classes.dex */
public class MyService24 extends Service {

    /* renamed from: a */
    static final boolean f10080a = false;

    /* renamed from: b */
    String f10081b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10083d = true;

    /* renamed from: c */
    MyReceiver f10082c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService24$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10084a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService24.this.f10081b, "on Recv");
            MyService24.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10082c = new MyReceiver();
        registerReceiver(this.f10082c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10082c;
        if (myReceiver != null) {
