...
/* renamed from: com.lbd.xj.zygote_service.MyService40 */
/* loaded from: classes.dex */
public class MyService40 extends Service {

    /* renamed from: a */
    static final boolean f10188a = false;

    /* renamed from: b */
    String f10189b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10191d = true;

    /* renamed from: c */
    MyReceiver f10190c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService40$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10192a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService40.this.f10189b, "on Recv");
            MyService40.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10190c = new MyReceiver();
        registerReceiver(this.f10190c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10190c;
        if (myReceiver != null) {
