...
/* renamed from: com.lbd.xj.zygote_service.MyService26 */
/* loaded from: classes.dex */
public class MyService26 extends Service {

    /* renamed from: a */
    static final boolean f10092a = false;

    /* renamed from: b */
    String f10093b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10095d = true;

    /* renamed from: c */
    MyReceiver f10094c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService26$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10096a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService26.this.f10093b, "on Recv");
            MyService26.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10094c = new MyReceiver();
        registerReceiver(this.f10094c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10094c;
        if (myReceiver != null) {
