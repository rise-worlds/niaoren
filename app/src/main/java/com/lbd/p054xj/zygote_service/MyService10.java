...
/* renamed from: com.lbd.xj.zygote_service.MyService10 */
/* loaded from: classes.dex */
public class MyService10 extends Service {

    /* renamed from: a */
    static final boolean f9990a = false;

    /* renamed from: b */
    String f9991b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f9993d = true;

    /* renamed from: c */
    MyReceiver f9992c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService10$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f9994a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService10.this.f9991b, "on Recv");
            MyService10.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f9992c = new MyReceiver();
        registerReceiver(this.f9992c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f9992c;
        if (myReceiver != null) {
