...
/* renamed from: com.lbd.xj.zygote_service.MyService20 */
/* loaded from: classes.dex */
public class MyService20 extends Service {

    /* renamed from: a */
    static final boolean f10056a = false;

    /* renamed from: b */
    String f10057b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10059d = true;

    /* renamed from: c */
    MyReceiver f10058c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService20$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10060a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService20.this.f10057b, "on Recv");
            MyService20.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10058c = new MyReceiver();
        registerReceiver(this.f10058c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10058c;
        if (myReceiver != null) {
