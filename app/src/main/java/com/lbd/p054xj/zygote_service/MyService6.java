...
/* renamed from: com.lbd.xj.zygote_service.MyService6 */
/* loaded from: classes.dex */
public class MyService6 extends Service {

    /* renamed from: a */
    static final boolean f10200a = false;

    /* renamed from: b */
    String f10201b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10203d = true;

    /* renamed from: c */
    MyReceiver f10202c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService6$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10204a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService6.this.f10201b, "on Recv");
            MyService6.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10202c = new MyReceiver();
        registerReceiver(this.f10202c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10202c;
        if (myReceiver != null) {
