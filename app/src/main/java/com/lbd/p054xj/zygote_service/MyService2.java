...
/* renamed from: com.lbd.xj.zygote_service.MyService2 */
/* loaded from: classes.dex */
public class MyService2 extends Service {

    /* renamed from: a */
    static final boolean f10050a = false;

    /* renamed from: b */
    String f10051b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10053d = true;

    /* renamed from: c */
    MyReceiver f10052c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService2$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10054a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService2.this.f10051b, "on Recv");
            MyService2.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10052c = new MyReceiver();
        registerReceiver(this.f10052c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10052c;
        if (myReceiver != null) {
