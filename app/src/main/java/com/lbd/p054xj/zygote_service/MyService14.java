...
/* renamed from: com.lbd.xj.zygote_service.MyService14 */
/* loaded from: classes.dex */
public class MyService14 extends Service {

    /* renamed from: a */
    static final boolean f10014a = false;

    /* renamed from: b */
    String f10015b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10017d = true;

    /* renamed from: c */
    MyReceiver f10016c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService14$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10018a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService14.this.f10015b, "on Recv");
            MyService14.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10016c = new MyReceiver();
        registerReceiver(this.f10016c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10016c;
        if (myReceiver != null) {
