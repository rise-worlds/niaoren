...
/* renamed from: com.lbd.xj.zygote_service.MyService15 */
/* loaded from: classes.dex */
public class MyService15 extends Service {

    /* renamed from: a */
    static final boolean f10020a = false;

    /* renamed from: b */
    String f10021b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10023d = true;

    /* renamed from: c */
    MyReceiver f10022c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService15$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10024a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService15.this.f10021b, "on Recv");
            MyService15.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10022c = new MyReceiver();
        registerReceiver(this.f10022c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10022c;
        if (myReceiver != null) {
