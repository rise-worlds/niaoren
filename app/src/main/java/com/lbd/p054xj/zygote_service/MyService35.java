...
/* renamed from: com.lbd.xj.zygote_service.MyService35 */
/* loaded from: classes.dex */
public class MyService35 extends Service {

    /* renamed from: a */
    static final boolean f10152a = false;

    /* renamed from: b */
    String f10153b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10155d = true;

    /* renamed from: c */
    MyReceiver f10154c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService35$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10156a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService35.this.f10153b, "on Recv");
            MyService35.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10154c = new MyReceiver();
        registerReceiver(this.f10154c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10154c;
        if (myReceiver != null) {
