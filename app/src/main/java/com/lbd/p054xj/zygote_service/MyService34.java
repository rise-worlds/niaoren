...
/* renamed from: com.lbd.xj.zygote_service.MyService34 */
/* loaded from: classes.dex */
public class MyService34 extends Service {

    /* renamed from: a */
    static final boolean f10146a = false;

    /* renamed from: b */
    String f10147b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10149d = true;

    /* renamed from: c */
    MyReceiver f10148c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService34$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10150a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService34.this.f10147b, "on Recv");
            MyService34.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10148c = new MyReceiver();
        registerReceiver(this.f10148c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10148c;
        if (myReceiver != null) {
