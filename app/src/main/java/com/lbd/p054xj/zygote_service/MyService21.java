...
/* renamed from: com.lbd.xj.zygote_service.MyService21 */
/* loaded from: classes.dex */
public class MyService21 extends Service {

    /* renamed from: a */
    static final boolean f10062a = false;

    /* renamed from: b */
    String f10063b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10065d = true;

    /* renamed from: c */
    MyReceiver f10064c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService21$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10066a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService21.this.f10063b, "on Recv");
            MyService21.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10064c = new MyReceiver();
        registerReceiver(this.f10064c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10064c;
        if (myReceiver != null) {
