...
/* renamed from: com.lbd.xj.zygote_service.MyServicexx */
/* loaded from: classes.dex */
public class MyServicexx extends Service {

    /* renamed from: a */
    static final boolean f10224a = false;

    /* renamed from: b */
    String f10225b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10227d = true;

    /* renamed from: c */
    MyReceiver f10226c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyServicexx$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10228a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyServicexx.this.f10225b, "on Recv");
            MyServicexx.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10226c = new MyReceiver();
        registerReceiver(this.f10226c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10226c;
        if (myReceiver != null) {
