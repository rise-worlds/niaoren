...
/* renamed from: com.lbd.xj.zygote_service.MyService30 */
/* loaded from: classes.dex */
public class MyService30 extends Service {

    /* renamed from: a */
    static final boolean f10122a = false;

    /* renamed from: b */
    String f10123b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10125d = true;

    /* renamed from: c */
    MyReceiver f10124c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService30$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10126a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService30.this.f10123b, "on Recv");
            MyService30.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10124c = new MyReceiver();
        registerReceiver(this.f10124c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10124c;
        if (myReceiver != null) {
