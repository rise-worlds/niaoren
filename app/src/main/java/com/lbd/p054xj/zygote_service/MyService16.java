...
/* renamed from: com.lbd.xj.zygote_service.MyService16 */
/* loaded from: classes.dex */
public class MyService16 extends Service {

    /* renamed from: a */
    static final boolean f10026a = false;

    /* renamed from: b */
    String f10027b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10029d = true;

    /* renamed from: c */
    MyReceiver f10028c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService16$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10030a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService16.this.f10027b, "on Recv");
            MyService16.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10028c = new MyReceiver();
        registerReceiver(this.f10028c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10028c;
        if (myReceiver != null) {
