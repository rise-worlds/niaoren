...
/* renamed from: com.lbd.xj.zygote_service.MyService1 */
/* loaded from: classes.dex */
public class MyService1 extends Service {

    /* renamed from: a */
    static final boolean f9984a = false;

    /* renamed from: b */
    String f9985b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f9987d = true;

    /* renamed from: c */
    MyReceiver f9986c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService1$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f9988a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService1.this.f9985b, "on Recv");
            MyService1.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f9986c = new MyReceiver();
        registerReceiver(this.f9986c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f9986c;
        if (myReceiver != null) {
