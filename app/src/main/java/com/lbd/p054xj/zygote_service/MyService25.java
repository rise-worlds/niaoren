...
/* renamed from: com.lbd.xj.zygote_service.MyService25 */
/* loaded from: classes.dex */
public class MyService25 extends Service {

    /* renamed from: a */
    static final boolean f10086a = false;

    /* renamed from: b */
    String f10087b = "SHENG_myservice";

    /* renamed from: d */
    private boolean f10089d = true;

    /* renamed from: c */
    MyReceiver f10088c = null;
    ...
    /* renamed from: com.lbd.xj.zygote_service.MyService25$MyReceiver */
    /* loaded from: classes.dex */
    public class MyReceiver extends BroadcastReceiver {

        /* renamed from: a */
        public static final String f10090a = "com.lbd.xj.system_exit";
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtils.m22038d(MyService25.this.f10087b, "on Recv");
            MyService25.this.killuid(Process.myUid());
            System.exit(0);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        this.f10088c = new MyReceiver();
        registerReceiver(this.f10088c, new IntentFilter("com.lbd.xj.system_exit"));
    ...
    public void onDestroy() {
        super.onDestroy();
        MyReceiver myReceiver = this.f10088c;
        if (myReceiver != null) {
