...
import com.lbd.p054xj.device.camera.CameraController;
import com.lbd.p054xj.device.lcd.DisplayParam;
import com.lbd.p054xj.device.location.LocationController;
import com.lbd.p054xj.device.sersor.SensorController;
import com.lbd.p054xj.device.wifi.WifiController;
import com.lbd.p054xj.keeplive.DaemonService;
import com.lbd.p054xj.keeplive.LiveActivity;
...
import com.lbd.p054xj.p056ui.dialog.LaunchFullDialog;
...
import com.lbd.p054xj.utils.vmlog.VMLogUtils;
...
public class XJFullActivity extends NativeActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        SocketManagerServer.m19692b().m19703a(new SocketManagerServer.AbstractC1534a() { // from class: com.lbd.xj.ui.activity.XJFullActivity.10
            @Override // com.lbd.p054xj.socket.SocketManagerServer.AbstractC1534a
            /* renamed from: a */
    ...
    void InitWifi() {
        if (mWifiController == null) {
            mWifiController = new WifiController(new WifiController.WIFIChangedListener() { // from class: com.lbd.xj.ui.activity.XJFullActivity.14
                @Override // com.lbd.p054xj.device.wifi.WifiController.WIFIChangedListener
    ...
    private void InitGPS() {
        if (mLocationController == null) {
            ...
            mLocationController.setGpsChangedListener(new LocationController.GpsChangedListener() { // from class: com.lbd.xj.ui.activity.XJFullActivity.15
                @Override // com.lbd.p054xj.device.location.LocationController.GpsChangedListener
        ...
        if (mSensorController == null) {
            ...
            if (sensorController == null) {
                ...
                sensorController.setSensorChangedListener(new SensorController.SensorChangedListener() { // from class: com.lbd.xj.ui.activity.XJFullActivity.2
                    @Override // com.lbd.p054xj.device.sersor.SensorController.SensorChangedListener
    ...
    static void getPreViewImage() {
        mCameraController.getPreViewImage(new CameraController.CameraPreviewListener() { // from class: com.lbd.xj.ui.activity.XJFullActivity.4
            @Override // com.lbd.p054xj.device.camera.CameraController.CameraPreviewListener
