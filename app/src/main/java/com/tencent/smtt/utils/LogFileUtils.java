...
public class LogFileUtils {
    ...
    /* renamed from: a */
    private static OutputStream f13261a;
    ...
    public static synchronized void writeDataToStorage(File file, String str, byte[] bArr, String str2, boolean z) {
        synchronized (LogFileUtils.class) {
            ...
            if (f13261a == null) {
                f13261a = new BufferedOutputStream(new FileOutputStream(file, z));
            }
            if (str2 != null) {
                f13261a.write(str2.getBytes());
            } else {
                f13261a.write(bArr);
                f13261a.write(encrypt);
                f13261a.write(new byte[]{10, 10});
            }
            if (f13261a != null) {
                try {
                    f13261a.flush();
