...
public class TbsMediaPlayer {
    ...
    /* renamed from: a */
    private TbsMediaPlayerWizard f12951a;
    ...
    public TbsMediaPlayer(TbsMediaPlayerWizard mVar) {
        this.f12951a = null;
        this.f12951a = mVar;
    }

    public boolean isAvailable() {
        return this.f12951a.m16667a();
    }

    public void setSurfaceTexture(SurfaceTexture surfaceTexture) {
        this.f12951a.m16663a(surfaceTexture);
    }

    public void setPlayerListener(TbsMediaPlayerListener tbsMediaPlayerListener) {
        this.f12951a.m16662a(tbsMediaPlayerListener);
    }

    public float getVolume() {
        return this.f12951a.m16660b();
    }

    public void setVolume(float f) {
        this.f12951a.m16666a(f);
    }

    public void startPlay(String str, Bundle bundle) {
        this.f12951a.m16661a(str, bundle);
    }

    public void subtitle(int i) {
        this.f12951a.m16665a(i);
    }

    public void audio(int i) {
        this.f12951a.m16659b(i);
    }

    public void pause() {
        this.f12951a.m16658c();
    }

    public void play() {
        this.f12951a.m16657d();
    }

    public void seek(long j) {
        this.f12951a.m16664a(j);
    }

    public void close() {
        this.f12951a.m16656e();
    }
}
