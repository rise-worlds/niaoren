...
public class HttpUtils {
    ...
    public HttpUtils(int i, String str) {
        ...
        schemeRegistry.register(new Scheme("https", DefaultSSLSocketFactory.getSocketFactory(), AbstractC2752bw.f13639b));
    ...
    public HttpUtils configSSLSocketFactory(SSLSocketFactory sSLSocketFactory) {
        this.httpClient.getConnectionManager().getSchemeRegistry().register(new Scheme("https", sSLSocketFactory, AbstractC2752bw.f13639b));
        return this;
    }
