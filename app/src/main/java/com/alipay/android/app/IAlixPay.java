...
public interface IAlixPay extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAlixPay {
        ...
        /* loaded from: classes.dex */
        private static class C0580a implements IAlixPay {

            /* renamed from: a */
            private IBinder f119a;

            /* renamed from: a */
            public String m25523a() {
            ...
            public String test() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f119a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
            ...
            public void registerCallback(IRemoteServiceCallback iRemoteServiceCallback) throws RemoteException {
                ...
                try {
                    ...
                    this.f119a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void unregisterCallback(IRemoteServiceCallback iRemoteServiceCallback) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeStrongBinder(iRemoteServiceCallback != null ? iRemoteServiceCallback.asBinder() : null);
                    this.f119a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public String prePay(String str) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeString(str);
                    this.f119a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
            ...
            public void deployFastConnect() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f119a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public boolean manager(String str) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    boolean z = false;
                    this.f119a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public int getVersion() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f119a.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public String pay02(String str, Map map) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeMap(map);
                    this.f119a.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
