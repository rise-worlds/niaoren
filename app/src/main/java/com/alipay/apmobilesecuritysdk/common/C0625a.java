...
public final class C0625a {
    /* renamed from: a */
    public static boolean m25426a(Context context) {
        ArrayList arrayList = new ArrayList();
        arrayList.add(C0638h.m25374e(context));
        return m25425a(arrayList) || m25425a(new ArrayList<String>() { // from class: com.alipay.apmobilesecuritysdk.common.RushTimeUtil$1
    ...
    /* renamed from: a */
    private static boolean m25425a(List<String> list) {
