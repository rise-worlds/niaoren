...
public final class Session {
    ...
    private Session(Properties properties, Authenticator authenticator) {
        ...
        if (this.debug) {
            m14882pr("DEBUG: JavaMail version 1.4.1");
        }
    ...
    public final synchronized void setDebug(boolean z) {
        this.debug = z;
        if (z) {
            m14882pr("DEBUG: setDebug: JavaMail version 1.4.1");
        }
    }
    ...
    public final synchronized Provider getProvider(String str) throws NoSuchProviderException {
        if (str != null) {
            if (str.length() > 0) {
                ...
                if (property != null) {
                    if (this.debug) {
                        m14882pr("DEBUG: mail." + str + ".class property exists and points to " + property);
                    }
                ...
                if (provider2 != null) {
                    if (this.debug) {
                        m14882pr("DEBUG: getProvider() returning " + provider2.toString());
                    }
                    return provider2;
                }
    ...
    private void loadProviders(Class cls) {
        ...
        try {
            ...
            if (this.debug) {
                m14882pr("DEBUG: can't get java.home: " + e);
            }
        }
        ...
        if (this.providers.size() == 0) {
            if (this.debug) {
                m14882pr("DEBUG: failed to load any providers, using defaults");
            }
        ...
        if (this.debug) {
            m14882pr("DEBUG: Tables of loaded providers");
            m14882pr("DEBUG: Providers Listed By Class Name: " + this.providersByClassName.toString());
            m14882pr("DEBUG: Providers Listed By Protocol: " + this.providersByProtocol.toString());
        }
    }
            ...
            while (true) {
                ...
                if (readLine != null) {
                    if (!readLine.startsWith("#")) {
                        StringTokenizer stringTokenizer = new StringTokenizer(readLine, C4963cj.f20745b);
                        ...
                        while (stringTokenizer.hasMoreTokens()) {
                            ...
                            int indexOf = trim.indexOf(SimpleComparison.f23609c);
                        ...
                        if (type != null && str != null && str2 != null && str.length() > 0 && str2.length() > 0) {
                            ...
                            m14882pr("DEBUG: Bad provider entry: " + readLine);
                        }
                    }
                } else {
                    return;
    ...
    private void loadAddressMap(Class cls) {
        ...
        if (this.addressMap.isEmpty()) {
            if (this.debug) {
                m14882pr("DEBUG: failed to load address map, using defaults");
            }
    ...
    private void loadFile(String str, StreamLoader streamLoader) {
        ...
        try {
            ...
            if (this.debug) {
                m14882pr("DEBUG: successfully loaded file: " + str);
            }
            try {
            ...
            if (this.debug) {
                m14882pr("DEBUG: not loading file: " + str);
                m14882pr("DEBUG: " + e);
            }
        ...
        try {
            try {
                ...
                if (inputStream != null) {
                    ...
                    if (this.debug) {
                        m14882pr("DEBUG: successfully loaded resource: " + str);
                    }
                } else if (this.debug) {
                    m14882pr("DEBUG: not loading resource: " + str);
                }
            } finally {
                if (inputStream != null) {
                    try {
    ...
    */
    ...
    /* renamed from: pr */
    private void m14882pr(String str) {
