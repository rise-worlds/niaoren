...
public class SharedFileInputStream extends BufferedInputStream implements SharedInputStream {
    ...
    /* renamed from: in */
    protected RandomAccessFile f14666in;
    private boolean master;

    /* renamed from: sf */
    private SharedFile f14667sf;
    ...
    public static class SharedFile {
        ...
        /* renamed from: in */
        private RandomAccessFile f14668in;

        SharedFile(String str) throws IOException {
            this.f14668in = new RandomAccessFile(str, "r");
        }

        SharedFile(File file) throws IOException {
            this.f14668in = new RandomAccessFile(file, "r");
        }

        public RandomAccessFile open() {
            this.cnt++;
            return this.f14668in;
        }
    ...
    private void init(SharedFile sharedFile, int i) throws IOException {
        this.f14667sf = sharedFile;
        this.f14666in = sharedFile.open();
        this.start = 0L;
        this.datalen = this.f14666in.length();
        this.bufsize = i;
        this.buf = new byte[i];
    }
    ...
    private void fill() throws IOException {
        ...
        this.count = this.pos;
        this.f14666in.seek(this.bufpos + this.pos);
        ...
        int read = this.f14666in.read(this.buf, this.pos, length);
        if (read > 0) {
    ...
    */
    public void close() throws java.io.IOException {
        /*
            r2 = this;
            java.io.RandomAccessFile r0 = r2.f14666in
            if (r0 != 0) goto L_0x0005
            return
        L_0x0005:
            r0 = 0
            boolean r1 = r2.master     // Catch: all -> 0x001c
            if (r1 == 0) goto L_0x0010
            javax.mail.util.SharedFileInputStream$SharedFile r1 = r2.f14667sf     // Catch: all -> 0x001c
            r1.forceClose()     // Catch: all -> 0x001c
            goto L_0x0015
        L_0x0010:
            javax.mail.util.SharedFileInputStream$SharedFile r1 = r2.f14667sf     // Catch: all -> 0x001c
        ...
        L_0x001c:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: javax.mail.util.SharedFileInputStream.close():void");
    }
    ...
    public InputStream newStream(long j, long j2) {
        if (this.f14666in == null) {
            ...
            return new SharedFileInputStream(this.f14667sf, this.start + ((int) j), (int) (j2 - j), this.bufsize);
        } else {
