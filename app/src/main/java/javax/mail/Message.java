...
public abstract class Message implements Part {
    ...
    public static class RecipientType implements Serializable {
        ...
        /* renamed from: TO */
        public static final RecipientType f14650TO = new RecipientType("To");

        /* renamed from: CC */
        public static final RecipientType f14649CC = new RecipientType("Cc");
    ...
    public Address[] getAllRecipients() throws MessagingException {
        int i;
        Address[] recipients = getRecipients(RecipientType.f14650TO);
        Address[] recipients2 = getRecipients(RecipientType.f14649CC);
